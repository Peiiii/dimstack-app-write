...
Open GitHub repositories in Gitary (`gitary.app`) with one click in your browser.
...
- `src/`: TypeScript source code
  ...
  - `github.ts`: Pure functions for GitHub URL parsing.
...
- Short Description (max 132 characters):
  - Open GitHub repositories in Gitary with one click, enjoy enhanced code reading and note-taking experience.
- Detailed Description (multi-paragraph):

> Gitary Companion lets you quickly open GitHub repositories in Gitary for a more professional code reading and knowledge management experience.  
>  
> Key Features:  
> - One-click jump: Click the extension icon on a GitHub repository page to open it in Gitary.  
> - Right-click open: Right-click on GitHub pages or repository links and select "Open in Gitary".  
> - Auto repository detection: Intelligently parses GitHub repository URLs, only works on supported pages.  
>  
