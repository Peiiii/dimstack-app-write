import { H as m, O as yt$1, a8 as B5, a7 as $5, a9 as D5, aa as F5, al as I5, ak as R5, ar as M5, ad as Ii, as as SI, a6 as gt$1, bk as T5 } from "./app-33e0c163.js";
...
var K = at, J = [], tt = [], Z = /* @__PURE__ */ new Map(), Zt = /* @__PURE__ */ m(() => {
  ...
  const { securityLevel: h$1, sankey: y } = yt$1(), m$1 = SI.sankey;
  let _;
...
${b}${Math.round(E * 100) / 100}${M}` : d, "getText");
  ...
  z.append("path").attr("d", Kt()).attr("stroke", $).attr("stroke-width", (d) => Math.max(1, d.width)), T5(void 0, o, 0, v);
}, "draw"), ce = {
  draw: le
