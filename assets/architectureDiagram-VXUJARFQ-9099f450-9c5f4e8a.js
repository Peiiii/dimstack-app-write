import { a4 as Vv, ax as Lf, H as m, bN as GM, bO as VM, a5 as Xv, a7 as $5, a8 as B5, ak as R5, al as I5, a9 as D5, aa as F5, ar as M5, ay as lu, az as Xt, M as R, a6 as gt, aK as bT, bk as T5, ap as OI, bE as Ar$1, O as yt, bP as aa, ag as _e } from "./app-ac489121.js";
import { m as m$1 } from "./chunk-4BX2VUAB-fea36534-f4c36768.js";
import { Y as Yy } from "./mermaid-parser.core-6f66fbe8-a030ef78.js";
import { e as ea } from "./cytoscape.esm-13077586-b17e4586.js";
import "./chakra-ui-1d60df8d.js";
import "./react-utils-0e8f4d03.js";
import "./_baseUniq-cfe137aa-1dc98072.js";
import "./_basePickBy-9e57dae2-8e140bd1.js";
import "./monaco-45e206c0.js";
import "./vendor-75a482ef.js";
import "./common-utils-40e9b830.js";
import "./clone-66b7ef27-0f863be1.js";
      ...
      return (
        ...
        function(A) {
          ...
          function(A, P, N) {
            ...
            function o(c, l, T) {
              u.call(this, T), this.estimatedSize = h.MIN_VALUE, this.margin = a.DEFAULT_GRAPH_MARGIN, this.edges = [], this.nodes = [], this.isConnected = false, this.parent = c, l != null && l instanceof r ? this.graphManager = l : l != null && l instanceof Layout && (this.graphManager = l.graphManager);
            }
            ...
            o.prototype.getNodes = function() {
              ...
              if (l == null && T == null) {
                ...
                return l.owner != T.owner ? null : (v.source = l, v.target = T, v.isInterGraph = false, this.getEdges().push(v), l.edges.push(v), T != l && T.edges.push(v), v);
              }
          ...
          function(A, P, N) {
            ...
            h.calcSeparationAmount = function(a, r, e, f) {
              ...
              if (a.intersects(r))
                return e[0] = f, e[1] = i, e[2] = g, e[3] = t, true;
              var o = a.getX(), s = a.getY(), c = a.getRight(), l = a.getX(), T = a.getBottom(), d = a.getRight(), v = a.getWidthHalf(), L = a.getHeightHalf(), S = r.getX(), C = r.getY(), G = r.getRight(), K = r.getX(), X = r.getBottom(), Q = r.getRight(), O = r.getWidthHalf(), rt = r.getHeightHalf(), n = false, E = false;
              if (f === g) {
                if (i > t)
                  return e[0] = f, e[1] = s, e[2] = g, e[3] = X, false;
                if (i < t)
                  return e[0] = f, e[1] = T, e[2] = g, e[3] = C, false;
              } else if (i === t) {
                if (f > g)
                  return e[0] = o, e[1] = i, e[2] = G, e[3] = t, false;
                if (f < g)
                  return e[0] = c, e[1] = i, e[2] = S, e[3] = t, false;
              } else {
                var p = a.height / a.width, m2 = r.height / r.width, y = (t - i) / (g - f), R2 = void 0, M = void 0, F = void 0, W = void 0, x = void 0, Z = void 0;
                if (-p === y ? f > g ? (e[0] = l, e[1] = T, n = true) : (e[0] = c, e[1] = s, n = true) : p === y && (f > g ? (e[0] = o, e[1] = s, n = true) : (e[0] = d, e[1] = T, n = true)), -m2 === y ? g > f ? (e[2] = K, e[3] = X, E = true) : (e[2] = G, e[3] = C, E = true) : m2 === y && (g > f ? (e[2] = S, e[3] = C, E = true) : (e[2] = Q, e[3] = X, E = true)), n && E)
                  return false;
                if (f > g ? i > t ? (R2 = this.getCardinalDirection(p, y, 4), M = this.getCardinalDirection(m2, y, 2)) : (R2 = this.getCardinalDirection(-p, y, 3), M = this.getCardinalDirection(-m2, y, 1)) : i > t ? (R2 = this.getCardinalDirection(-p, y, 1), M = this.getCardinalDirection(-m2, y, 3)) : (R2 = this.getCardinalDirection(p, y, 2), M = this.getCardinalDirection(m2, y, 4)), !n)
                  switch (R2) {
                    case 1:
          ...
          function(A, P, N) {
            ...
            o.RANDOM_SEED = 1, o.prototype = Object.create(t.prototype), o.prototype.getGraphManager = function() {
              ...
              for (var s = [], c = true, l = this.graphManager.getRoot().getNodes(), T = true, d = 0; d < l.length; d++)
                l[d].getChild() != null && (T = false);
              if (!T)
                return s;
              ...
              var c = [];
              c = c.concat(s);
              var l = [], T = /* @__PURE__ */ new Map(), d = false, v = null;
              ...
              for (G = G.concat(l); !d; ) {
                ...
                l = l.concat(G), (c.length == 1 || c.length == 2) && (d = true, v = c[0]);
              }
              return v;
          ...
          function(A, P, N) {
            ...
            i.prototype.initParameters = function() {
              ...
              var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : true, o = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : false, s, c, l, T, d = this.getAllNodes(), v;
          ...
          function(A, P, N) {
            ...
            u.svd = function(h) {
              ...
              i < this.n && (this.s[i] = h[i][i]), this.m < n && (this.s[n - 1] = 0), g + 1 < n && (r[g] = h[g][n - 1]), r[n - 1] = 0;
              {
                ...
                for (var m2 = i - 1; m2 >= 0; m2--)
                  if (this.s[m2] !== 0) {
                    for (var y = m2 + 1; y < a; y++) {
                      for (var R2 = 0, M = m2; M < this.m; M++)
                        R2 += this.U[M][m2] * this.U[M][y];
                      R2 = -R2 / this.U[m2][m2];
                      for (var F = m2; F < this.m; F++)
                        this.U[F][y] += R2 * this.U[F][m2];
                    }
                    for (var W = m2; W < this.m; W++)
                      this.U[W][m2] = -this.U[W][m2];
                    this.U[m2][m2] = 1 + this.U[m2][m2];
                    for (var x = 0; x < m2 - 1; x++)
                      this.U[x][m2] = 0;
                  } else {
                  ...
                  case 1:
                    {
                      var it = r[n - 2];
                      r[n - 2] = 0;
                      for (var gt2 = n - 2; gt2 >= q; gt2--) {
                        var Et = u.hypot(this.s[gt2], it), At = this.s[gt2] / Et, Ot = it / Et;
                        this.s[gt2] = Et, gt2 !== q && (it = -Ot * r[gt2 - 1], r[gt2 - 1] = At * r[gt2 - 1]);
                        for (var mt = 0; mt < this.n; mt++)
                          Et = At * this.V[mt][gt2] + Ot * this.V[mt][n - 1], this.V[mt][n - 1] = -Ot * this.V[mt][gt2] + At * this.V[mt][n - 1], this.V[mt][gt2] = Et;
                      }
                    }
                    break;
                  case 2:
              ...
              var Xt2 = { U: this.U, V: this.V, S: this.s };
              return Xt2;
            ...
            var u = function() {
              function r(e, f) {
                for (var i = 0; i < f.length; i++) {
                  var g = f[i];
                  g.enumerable = g.enumerable || false, g.configurable = true, "value" in g && (g.writable = true), Object.defineProperty(e, g.key, g);
                }
              }
          ...
          var P = {
            ...
            765: (
              ...
              (a, r, e) => {
                ...
                O.prototype.newGraphManager = function() {
                  ...
                  if (this.nodesWithGravity = this.calculateNodesToApplyGravitationTo(), this.graphManager.setAllNodesToApplyGravitation(this.nodesWithGravity), this.calcNoOfChildrenForAllNodes(), this.graphManager.calcLowestCommonAncestors(), this.graphManager.calcInclusionTreeDepths(), this.graphManager.getRoot().calcEstimatedSize(), this.calcIdealEdgeLengths(), this.incremental) {
                    if (s.TREE_REDUCTION_ON_INCREMENTAL) {
                      ...
                      var E = new Set(this.getAllNodes()), p = this.nodesWithGravity.filter(function(R2) {
                        return E.has(R2);
                      });
                    ...
                    if (n.length > 0)
                      ...
                      this.reduceTrees(), this.graphManager.resetAllNodesToApplyGravitation();
                      var E = new Set(this.getAllNodes()), p = this.nodesWithGravity.filter(function(m2) {
                        return E.has(m2);
                      });
                  ...
                  if (this.isTreeGrowing) {
                    if (this.growTreeIterations % 10 == 0)
                      if (this.prunedNodesAll.length > 0) {
                        ...
                        this.graphManager.setAllNodesToApplyGravitation(E), this.graphManager.updateBounds(), this.updateGrid(), s.PURE_INCREMENTAL ? this.coolingFactor = l.DEFAULT_COOLING_FACTOR_INCREMENTAL / 2 : this.coolingFactor = l.DEFAULT_COOLING_FACTOR_INCREMENTAL;
                      } else
                  ...
                  var p = !this.isTreeGrowing && !this.isGrowthFinished, m2 = this.growTreeIterations % 10 == 1 && this.isTreeGrowing || this.afterGrowthIterations % 10 == 1 && this.isGrowthFinished;
                  return this.totalDisplacement = 0, this.graphManager.updateBounds(), this.calcSpringForces(), this.calcRepulsionForces(p, m2), this.calcGravitationalForces(), this.moveNodes(), this.animate(), false;
                }, O.prototype.getPositionsData = function() {
                  for (var n = this.graphManager.getAllNodes(), E = {}, p = 0; p < n.length; p++) {
                    var m2 = n[p].rect, y = n[p].id;
                    E[y] = {
                      id: y,
                      x: m2.getCenterX(),
                      y: m2.getCenterY(),
                  ...
                  if (this.constraints.fixedNodeConstraint) {
                    ...
                    for (var E = this.graphManager.getAllNodes(), m2, p = 0; p < E.length; p++)
                      if (m2 = E[p], m2.getChild() != null) {
                        var R2 = y(m2);
                        R2 > 0 && (m2.fixedNodeWeight = R2);
                      }
                  }
                      ...
                      var Y = function(H, B) {
                        ...
                        return H.forEach(function(vt, it) {
                          if (!It.has(it)) {
                            _[Nt] = [], ht[Nt] = false;
                            var gt2 = it;
                            for (q.push(gt2), It.add(gt2), _[Nt].push(gt2); q.length != 0; ) {
                              gt2 = q.shift(), B.has(gt2) && (ht[Nt] = true);
                              var Et = H.get(gt2);
                              Et.forEach(function(At) {
                  ...
                  if (this.constraints.fixedNodeConstraint && this.constraints.fixedNodeConstraint.forEach(function(z) {
                    ...
                    if (this.constraints.alignmentConstraint.vertical)
                      for (var E = this.constraints.alignmentConstraint.vertical, p = 0; p < E.length; p++) {
                        for (var m2 = 0, y = 0; y < E[p].length; y++) {
                          if (this.fixedNodeSet.has(E[p][y])) {
                            m2 = 0;
                            break;
                          }
                          m2 += this.idToNodeMap.get(E[p][y]).displacementX;
                        }
                        for (var R2 = m2 / E[p].length, y = 0; y < E[p].length; y++)
                          this.idToNodeMap.get(E[p][y]).displacementX = R2;
                      }
                    if (this.constraints.alignmentConstraint.horizontal)
                  ...
                  var n = [], E, p = this.graphManager.getGraphs(), m2 = p.length, y;
                  for (y = 0; y < m2; y++)
                  ...
                  for (p = 0; p < n.length; p++) {
                    var m2 = n[p];
                    if (!E.has(m2)) {
                      var y = m2.getSource(), R2 = m2.getTarget();
                      if (y == R2)
                        m2.getBendpoints().push(new v()), m2.getBendpoints().push(new v()), this.createDummyNodesForBendpoints(m2), E.add(m2);
                      else {
                        var M = [];
                        if (M = M.concat(y.getEdgeListToNode(R2)), M = M.concat(R2.getEdgeListToNode(y)), !E.has(M[0])) {
                          if (M.length > 1) {
                            var F;
                  ...
                  for (var E = new d(0, 0), p = Math.ceil(Math.sqrt(n.length)), m2 = 0, y = 0, R2 = 0, M = new v(0, 0), F = 0; F < n.length; F++) {
                    F % p == 0 && (R2 = 0, y = m2, F != 0 && (y += s.DEFAULT_COMPONENT_SEPERATION), m2 = 0);
                    var W = n[F], x = S.findCenterOfTree(W);
                    E.x = R2, E.y = y, M = O.radialLayout(W, x, E), M.y > m2 && (m2 = Math.floor(M.y)), R2 = Math.floor(M.x + s.DEFAULT_COMPONENT_SEPERATION);
                  }
                  this.transform(new v(T.WORLD_CENTER_X - M.x / 2, T.WORLD_CENTER_Y - M.y / 2));
                }, O.radialLayout = function(n, E, p) {
                  var m2 = Math.max(this.maxDiagonalInTree(n), s.DEFAULT_RADIAL_SEPARATION);
                  O.branchRadialLayout(E, null, 0, 359, 0, m2);
                  var y = K.calculateBounds(n), R2 = new X();
                  R2.setDeviceOrgX(y.getMinX()), R2.setDeviceOrgY(y.getMinY()), R2.setWorldOrgX(p.x), R2.setWorldOrgY(p.y);
                  for (var M = 0; M < n.length; M++) {
                    var F = n[M];
                    F.transform(R2);
                  }
                  var W = new v(y.getMaxX(), y.getMaxY());
                  return R2.inverseTransformPoint(W);
                }, O.branchRadialLayout = function(n, E, p, m2, y, R2) {
                  var M = (m2 - p + 1) / 2;
                  M < 0 && (M += 180);
                  ...
                  var Y = V.length;
                  E != null && Y--;
                  for (var et = 0, z = V.length, w, H = n.getEdgesBetween(E); H.length > 1; ) {
                    var B = H[0];
                    H.splice(0, 1);
                    var _ = V.indexOf(B);
                    _ >= 0 && V.splice(_, 1), z--, Y--;
                  }
                  E != null ? w = (V.indexOf(H[0]) + 1) % z : w = 0;
                  for (var ht = Math.abs(m2 - p) / Y, q = w; et != Y; q = ++q % z) {
                    var It = V[q].getOtherEnd(n);
                    if (It != E) {
                      var Nt = (p + et * ht) % 360, vt = (Nt + ht) % 360;
                      O.branchRadialLayout(It, n, Nt, vt, y + R2, R2), et++;
                    }
                  }
                }, O.maxDiagonalInTree = function(n) {
                  for (var E = C.MIN_VALUE, p = 0; p < n.length; p++) {
                    var m2 = n[p], y = m2.getDiagonal();
                    y > E && (E = y);
                  }
                  return E;
                  ...
                  for (var p = [], m2 = this.graphManager.getAllNodes(), y = 0; y < m2.length; y++) {
                    var R2 = m2[y], M = R2.getParent();
                    this.getNodeDegreeWithChildren(R2) === 0 && (M.id == null || !this.getToBeTiled(M)) && p.push(R2);
                  }
                  for (var y = 0; y < p.length; y++) {
                    var R2 = p[y], F = R2.getParent().id;
                    typeof E[F] > "u" && (E[F] = []), E[F] = E[F].concat(R2);
                  }
                  Object.keys(E).forEach(function(W) {
                    if (E[W].length > 1) {
                      var x = "DummyCompound_" + W;
                      n.memberGroups[x] = E[W];
                      var Z = E[W][0].getParent(), V = new t(n.graphManager);
                  ...
                  Object.keys(this.memberGroups).forEach(function(p) {
                    var m2 = n.idToDummyNode[p];
                    if (E[p] = n.tileNodes(n.memberGroups[p], m2.paddingLeft + m2.paddingRight), m2.rect.width = E[p].width, m2.rect.height = E[p].height, m2.setCenter(E[p].centerX, E[p].centerY), m2.labelMarginLeft = 0, m2.labelMarginTop = 0, s.NODE_DIMENSIONS_INCLUDE_LABELS) {
                      var y = m2.rect.width, R2 = m2.rect.height;
                      m2.labelWidth && (m2.labelPosHorizontal == "left" ? (m2.rect.x -= m2.labelWidth, m2.setWidth(y + m2.labelWidth), m2.labelMarginLeft = m2.labelWidth) : m2.labelPosHorizontal == "center" && m2.labelWidth > y ? (m2.rect.x -= (m2.labelWidth - y) / 2, m2.setWidth(m2.labelWidth), m2.labelMarginLeft = (m2.labelWidth - y) / 2) : m2.labelPosHorizontal == "right" && m2.setWidth(y + m2.labelWidth)), m2.labelHeight && (m2.labelPosVertical == "top" ? (m2.rect.y -= m2.labelHeight, m2.setHeight(R2 + m2.labelHeight), m2.labelMarginTop = m2.labelHeight) : m2.labelPosVertical == "center" && m2.labelHeight > R2 ? (m2.rect.y -= (m2.labelHeight - R2) / 2, m2.setHeight(m2.labelHeight), m2.labelMarginTop = (m2.labelHeight - R2) / 2) : m2.labelPosVertical == "bottom" && m2.setHeight(R2 + m2.labelHeight));
                    }
                  });
                }, O.prototype.repopulateCompounds = function() {
                  for (var n = this.compoundOrder.length - 1; n >= 0; n--) {
                    var E = this.compoundOrder[n], p = E.id, m2 = E.paddingLeft, y = E.paddingTop, R2 = E.labelMarginLeft, M = E.labelMarginTop;
                    this.adjustLocations(this.tiledMemberPack[p], E.rect.x, E.rect.y, m2, y, R2, M);
                  }
                }, O.prototype.repopulateZeroDegreeMembers = function() {
                  var n = this, E = this.tiledZeroDegreePack;
                  Object.keys(E).forEach(function(p) {
                    var m2 = n.idToDummyNode[p], y = m2.paddingLeft, R2 = m2.paddingTop, M = m2.labelMarginLeft, F = m2.labelMarginTop;
                    n.adjustLocations(E[p], m2.rect.x, m2.rect.y, y, R2, M, F);
                  });
                  ...
                  for (var m2 = p.getNodes(), y = 0; y < m2.length; y++) {
                    var R2 = m2[y];
                    if (this.getNodeDegree(R2) > 0)
                      return this.toBeTiled[E] = false, false;
                    if (R2.getChild() == null) {
                      this.toBeTiled[R2.id] = false;
                      continue;
                    }
                    if (!this.getToBeTiled(R2))
                      return this.toBeTiled[E] = false, false;
                  }
                  return this.toBeTiled[E] = true, true;
                }, O.prototype.getNodeDegree = function(n) {
                  n.id;
                  for (var E = n.getEdges(), p = 0, m2 = 0; m2 < E.length; m2++) {
                    var y = E[m2];
                  ...
                  if (n.getChild() == null)
                    return E;
                  for (var p = n.getChild().getNodes(), m2 = 0; m2 < p.length; m2++) {
                    var y = p[m2];
                ...
                }, O.prototype.adjustLocations = function(n, E, p, m2, y, R2, M) {
                  E += m2 + R2, p += y + M;
                  for (var F = E, W = 0; W < n.rows.length; W++) {
                    ...
                    for (var Z = 0, V = 0; V < x.length; V++) {
                      var Y = x[V];
                      Y.rect.x = E, Y.rect.y = p, E += Y.rect.width + n.horizontalPadding, Y.rect.height > Z && (Z = Y.rect.height);
                    }
                    p += Z + n.verticalPadding;
                  }
                }, O.prototype.tileCompoundMembers = function(n, E) {
                  var p = this;
                  this.tiledMemberPack = [], Object.keys(n).forEach(function(m2) {
                    var y = E[m2];
                    if (p.tiledMemberPack[m2] = p.tileNodes(n[m2], y.paddingLeft + y.paddingRight), y.rect.width = p.tiledMemberPack[m2].width, y.rect.height = p.tiledMemberPack[m2].height, y.setCenter(p.tiledMemberPack[m2].centerX, p.tiledMemberPack[m2].centerY), y.labelMarginLeft = 0, y.labelMarginTop = 0, s.NODE_DIMENSIONS_INCLUDE_LABELS) {
                      var R2 = y.rect.width, M = y.rect.height;
                      y.labelWidth && (y.labelPosHorizontal == "left" ? (y.rect.x -= y.labelWidth, y.setWidth(R2 + y.labelWidth), y.labelMarginLeft = y.labelWidth) : y.labelPosHorizontal == "center" && y.labelWidth > R2 ? (y.rect.x -= (y.labelWidth - R2) / 2, y.setWidth(y.labelWidth), y.labelMarginLeft = (y.labelWidth - R2) / 2) : y.labelPosHorizontal == "right" && y.setWidth(R2 + y.labelWidth)), y.labelHeight && (y.labelPosVertical == "top" ? (y.rect.y -= y.labelHeight, y.setHeight(M + y.labelHeight), y.labelMarginTop = y.labelHeight) : y.labelPosVertical == "center" && y.labelHeight > M ? (y.rect.y -= (y.labelHeight - M) / 2, y.setHeight(y.labelHeight), y.labelMarginTop = (y.labelHeight - M) / 2) : y.labelPosVertical == "bottom" && y.setHeight(M + y.labelHeight));
                    }
                  });
                }, O.prototype.tileNodes = function(n, E) {
                  var p = this.tileNodesByFavoringDim(n, E, true), m2 = this.tileNodesByFavoringDim(n, E, false), y = this.getOrgRatio(p), R2 = this.getOrgRatio(m2), M;
                  return R2 < y ? M = m2 : M = p, M;
                }, O.prototype.getOrgRatio = function(n) {
                  var E = n.width, p = n.height, m2 = E / p;
                  return m2 < 1 && (m2 = 1 / m2), m2;
                }, O.prototype.calcIdealRowWidth = function(n, E) {
                  var p = s.TILING_PADDING_VERTICAL, m2 = s.TILING_PADDING_HORIZONTAL, y = n.length, R2 = 0, M = 0, F = 0;
                  n.forEach(function(z) {
                    R2 += z.getWidth(), M += z.getHeight(), z.getWidth() > F && (F = z.getWidth());
                  });
                  var W = R2 / y, x = M / y, Z = Math.pow(p - m2, 2) + 4 * (W + m2) * (x + p) * y, V = (m2 - p + Math.sqrt(Z)) / (2 * (W + m2)), Y;
                  E ? (Y = Math.ceil(V), Y == V && Y++) : Y = Math.floor(V);
                  var et = Y * (W + m2) - m2;
                  return F > et && (et = F), et += m2 * 2, et;
                }, O.prototype.tileNodesByFavoringDim = function(n, E, p) {
                  var m2 = s.TILING_PADDING_VERTICAL, y = s.TILING_PADDING_HORIZONTAL, R2 = s.TILING_COMPARE_BY, M = {
                    rows: [],
                    rowWidth: [],
                    rowHeight: [],
                    width: 0,
                  ...
                  R2 && (M.idealRowWidth = this.calcIdealRowWidth(n, p));
                  var F = function(w) {
                  ...
                  n.sort(function(z, w) {
                    var H = W;
                    return M.idealRowWidth ? (H = R2, H(z.id, w.id)) : H(z, w);
                  });
                  ...
                  for (var V = 0; V < n.length; V++) {
                    ...
                    if (M.rows.length == 0)
                      ...
                      M.idealRowWidth || (et = this.getShortestRowIndex(M)), this.insertNodeToRow(M, Y, et, E);
                    } else
                      this.insertNodeToRow(M, Y, M.rows.length, E);
                    this.shiftToLastRow(M);
                  }
                  return M;
                }, O.prototype.insertNodeToRow = function(n, E, p, m2) {
                  var y = m2;
                  if (p == n.rows.length) {
                    var R2 = [];
                    n.rows.push(R2), n.rowWidth.push(y), n.rowHeight.push(0);
                  }
                  var M = n.rowWidth[p] + E.rect.width;
                  n.rows[p].length > 0 && (M += n.horizontalPadding), n.rowWidth[p] = M, n.width < M && (n.width = M);
                  var F = E.rect.height;
                  p > 0 && (F += n.verticalPadding);
                  var W = 0;
                  F > n.rowHeight[p] && (W = n.rowHeight[p], n.rowHeight[p] = F, W = n.rowHeight[p] - W), n.height += W, n.rows[p].push(E);
                }, O.prototype.getShortestRowIndex = function(n) {
                  for (var E = -1, p = Number.MAX_VALUE, m2 = 0; m2 < n.rows.length; m2++)
                    n.rowWidth[m2] < p && (E = m2, p = n.rowWidth[m2]);
                  return E;
                }, O.prototype.getLongestRowIndex = function(n) {
                  for (var E = -1, p = Number.MIN_VALUE, m2 = 0; m2 < n.rows.length; m2++)
                    n.rowWidth[m2] > p && (E = m2, p = n.rowWidth[m2]);
                  return E;
                }, O.prototype.canAddHorizontal = function(n, E, p) {
                  if (n.idealRowWidth) {
                    var m2 = n.rows.length - 1, y = n.rowWidth[m2];
                    return y + E + n.horizontalPadding <= n.idealRowWidth;
                  }
                  var R2 = this.getShortestRowIndex(n);
                  if (R2 < 0)
                    return true;
                  var M = n.rowWidth[R2];
                  if (M + n.horizontalPadding + E <= n.width)
                    return true;
                  var F = 0;
                  n.rowHeight[R2] < p && R2 > 0 && (F = p + n.verticalPadding - n.rowHeight[R2]);
                  var W;
                  n.width - M >= E + n.horizontalPadding ? W = (n.height + F) / (M + E + n.horizontalPadding) : W = (n.height + F) / n.width, F = p + n.verticalPadding;
                  var x;
                  return n.width < E ? x = (n.height + F) / E : x = (n.height + F) / n.width, x < 1 && (x = 1 / x), W < 1 && (W = 1 / W), W < x;
                }, O.prototype.shiftToLastRow = function(n) {
                  var E = this.getLongestRowIndex(n), p = n.rowWidth.length - 1, m2 = n.rows[E], y = m2[m2.length - 1], R2 = y.width + n.horizontalPadding;
                  if (n.width - n.rowWidth[p] > R2 && E != p) {
                    m2.splice(-1, 1), n.rows[p].push(y), n.rowWidth[E] = n.rowWidth[E] - R2, n.rowWidth[p] = n.rowWidth[p] + R2, n.width = n.rowWidth[instance.getLongestRowIndex(n)];
                    for (var M = Number.MIN_VALUE, F = 0; F < m2.length; F++)
                      m2[F].height > M && (M = m2[F].height);
                    E > 0 && (M += n.verticalPadding);
                    var W = n.rowHeight[E] + n.rowHeight[p];
                    n.rowHeight[E] = M, n.rowHeight[p] < y.height + n.verticalPadding && (n.rowHeight[p] = y.height + n.verticalPadding);
                  ...
                  for (var n = [], E = true, p; E; ) {
                    var m2 = this.graphManager.getAllNodes(), y = [];
                    E = false;
                    for (var R2 = 0; R2 < m2.length; R2++)
                      if (p = m2[R2], p.getEdges().length == 1 && !p.getEdges()[0].isInterGraph && p.getChild() == null) {
                  ...
                  for (var E = n.length, p = n[E - 1], m2, y = 0; y < p.length; y++)
                    m2 = p[y], this.findPlaceforPrunedNode(m2), m2[2].add(m2[0]), m2[2].add(m2[1], m2[1].source, m2[1].target);
                  ...
                  var E, p, m2 = n[0];
                  if (m2 == n[1].source ? p = n[1].target : p = n[1].source, s.PURE_INCREMENTAL)
                    m2.setCenter(p.getCenterX() + n[3].getWidth(), p.getCenterY() + n[3].getHeight());
                  else {
                    var y = p.startX, R2 = p.finishX, M = p.startY, F = p.finishY, W = 0, x = 0, Z = 0, V = 0, Y = [W, Z, x, V];
                    if (M > 0)
                      for (var et = y; et <= R2; et++)
                        Y[0] += this.grid[et][M - 1].length + this.grid[et][M].length - 1;
                    if (R2 < this.grid.length - 1)
                      for (var et = M; et <= F; et++)
                        Y[1] += this.grid[R2 + 1][et].length + this.grid[R2][et].length - 1;
                    ...
                    if (w == 3 && z == 0)
                      ...
                      Y[0] == 0 && Y[1] == 0 ? _ == 0 ? E = 0 : E = 1 : Y[0] == 0 && Y[2] == 0 ? _ == 0 ? E = 0 : E = 2 : Y[0] == 0 && Y[3] == 0 ? _ == 0 ? E = 0 : E = 3 : Y[1] == 0 && Y[2] == 0 ? _ == 0 ? E = 1 : E = 2 : Y[1] == 0 && Y[3] == 0 ? _ == 0 ? E = 1 : E = 3 : _ == 0 ? E = 2 : E = 3;
                    } else if (w == 4 && z == 0) {
                      var _ = Math.floor(Math.random() * 4);
                      E = _;
                    } else
                      E = H;
                    E == 0 ? m2.setCenter(p.getCenterX(), p.getCenterY() - p.getHeight() / 2 - l.DEFAULT_EDGE_LENGTH - m2.getHeight() / 2) : E == 1 ? m2.setCenter(p.getCenterX() + p.getWidth() / 2 + l.DEFAULT_EDGE_LENGTH + m2.getWidth() / 2, p.getCenterY()) : E == 2 ? m2.setCenter(p.getCenterX(), p.getCenterY() + p.getHeight() / 2 + l.DEFAULT_EDGE_LENGTH + m2.getHeight() / 2) : m2.setCenter(p.getCenterX() - p.getWidth() / 2 - l.DEFAULT_EDGE_LENGTH - m2.getWidth() / 2, p.getCenterY());
                  }
                }, a.exports = O;
              }
            ),
              ...
              (a, r, e) => {
                ...
                s.handleConstraints = function(c) {
                  ...
                  var X = function(U, $) {
                    ...
                    function ct(lt, ot) {
                      var Lt = new Set(lt), ft = true, st = false, Xt2 = void 0;
                      try {
                        for (var Tt = ot[Symbol.iterator](), Ct; !(ft = (Ct = Tt.next()).done); ft = true) {
                          var Bt = Ct.value;
                          Lt.add(Bt);
                        }
                      } catch (bt) {
                        ...
                        if (tt.get(ft.id) < tt.get(ot) + ft.gap)
                          if (J && J.has(ft.id)) {
                            ...
                            if ($ == "horizontal" ? st = d.has(ft.id) ? v[d.get(ft.id)] : k.get(ft.id) : st = d.has(ft.id) ? L[d.get(ft.id)] : k.get(ft.id), tt.set(ft.id, st), st < tt.get(ot) + ft.gap) {
                              var Xt2 = tt.get(ot) + ft.gap - st;
                              j.get(ot).forEach(function(Tt) {
                                tt.set(Tt, tt.get(Tt) - Xt2);
                              });
                            }
                          } else
                    ...
                    if (J) {
                      ...
                      j.forEach(function(lt, ot) {
                        if (pt.has(ot)) {
                          var Lt = false, ft = true, st = false, Xt2 = void 0;
                          try {
                            for (var Tt = lt[Symbol.iterator](), Ct; !(ft = (Ct = Tt.next()).done); ft = true) {
                              var Bt = Ct.value;
                              J.has(Bt) && (Lt = true);
                            }
                          } catch (St) {
                          ...
                          if (!Lt) {
                            ...
                            xt.forEach(function(St, kt) {
                              St.has([].concat(f(lt))[0]) && (bt = true, zt = kt);
                        ...
                        var Lt = Number.POSITIVE_INFINITY, ft = Number.POSITIVE_INFINITY, st = Number.NEGATIVE_INFINITY, Xt2 = Number.NEGATIVE_INFINITY, Tt = true, Ct = false, Bt = void 0;
                        try {
                          for (var bt = lt[Symbol.iterator](), zt; !(Tt = (zt = bt.next()).done); Tt = true) {
                            ...
                            var Kt = tt.get(St);
                            kt < Lt && (Lt = kt), kt > st && (st = kt), Kt < ft && (ft = Kt), Kt > Xt2 && (Xt2 = Kt);
                          }
                        } catch (ee) {
                          Ct = true, Bt = ee;
                        } finally {
                        ...
                        var he = (Lt + st) / 2 - (ft + Xt2) / 2, Qt = true, jt = false, _t = void 0;
                        try {
                  ...
                  }, m2 = [], y = [], R2 = false, M = false, F = /* @__PURE__ */ new Set(), W = /* @__PURE__ */ new Map(), x = /* @__PURE__ */ new Map(), Z = [];
                  ...
                  }), x = E(W), Z = n(x)), i.TRANSFORM_ON_CONSTRAINT_HANDLING) {
                    if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 1)
                      l.fixedNodeConstraint.forEach(function(b, U) {
                        m2[U] = [b.position.x, b.position.y], y[U] = [v[d.get(b.nodeId)], L[d.get(b.nodeId)]];
                      }), R2 = true;
                        ...
                        if (l.alignmentConstraint.vertical) {
                          for (var U = l.alignmentConstraint.vertical, $ = function(tt) {
                            ...
                            ut.size > 0 ? Mt = v[d.get(ut.values().next().value)] : Mt = Q(j).x, U[tt].forEach(function(pt) {
                              m2[b] = [Mt, L[d.get(pt)]], y[b] = [v[d.get(pt)], L[d.get(pt)]], b++;
                            });
                          }, J = 0; J < U.length; J++)
                            $(J);
                          R2 = true;
                        ...
                        if (l.alignmentConstraint.horizontal) {
                          for (var k = l.alignmentConstraint.horizontal, at = function(tt) {
                            ...
                            ut.size > 0 ? Mt = v[d.get(ut.values().next().value)] : Mt = Q(j).y, k[tt].forEach(function(pt) {
                              m2[b] = [v[d.get(pt)], Mt], y[b] = [v[d.get(pt)], L[d.get(pt)]], b++;
                            });
                          }, ct = 0; ct < k.length; ct++)
                            at(ct);
                          R2 = true;
                        }
                        l.relativePlacementConstraint && (M = true);
                      })();
                    else if (l.relativePlacementConstraint) {
                      for (var V = 0, Y = 0, et = 0; et < Z.length; et++)
                        Z[et].length > V && (V = Z[et].length, Y = et);
                      if (V < x.size / 2)
                        rt(l.relativePlacementConstraint), R2 = false, M = false;
                      else {
                        ...
                        Z[Y].forEach(function(b, U) {
                          y[U] = [v[d.get(b)], L[d.get(b)]], m2[U] = [], B.has(b) ? m2[U][0] = B.get(b) : m2[U][0] = v[d.get(b)], _.has(b) ? m2[U][1] = _.get(b) : m2[U][1] = L[d.get(b)];
                        }), R2 = true;
                      }
                    }
                    if (R2) {
                      for (var ht = void 0, q = t.transpose(m2), It = t.transpose(y), Nt = 0; Nt < q.length; Nt++)
                      ...
                      for (var gt2 = 0; gt2 < d.size; gt2++) {
                        var Et = [v[gt2], L[gt2]], At = [ht[0][0], ht[1][0]], Ot = [ht[0][1], ht[1][1]];
                        v[gt2] = t.dotProduct(Et, At), L[gt2] = t.dotProduct(Et, Ot);
                      }
                  ...
                  if (i.ENFORCE_CONSTRAINTS) {
                    if (l.fixedNodeConstraint && l.fixedNodeConstraint.length > 0) {
                      ...
                      l.fixedNodeConstraint.forEach(function(b, U) {
                        ...
                        mt.x += k.x, mt.y += k.y;
                      }), mt.x /= l.fixedNodeConstraint.length, mt.y /= l.fixedNodeConstraint.length, v.forEach(function(b, U) {
                        v[U] += mt.x;
                    ...
                    l.relativePlacementConstraint && function() {
                      ...
                      if (F.forEach(function(Gt) {
                        ...
                        if (l.alignmentConstraint.vertical)
                          for (var tt = l.alignmentConstraint.vertical, j = function(yt2) {
                            $.set("dummy" + yt2, []), tt[yt2].forEach(function(wt) {
                              b.set(wt, "dummy" + yt2), $.get("dummy" + yt2).push(wt), F.has(wt) && ct.add("dummy" + yt2);
                            }), k.set("dummy" + yt2, v[d.get(tt[yt2][0])]);
                          }, ut = 0; ut < tt.length; ut++)
                            j(ut);
                        if (l.alignmentConstraint.horizontal)
                          for (var Mt = l.alignmentConstraint.horizontal, pt = function(yt2) {
                            J.set("dummy" + yt2, []), Mt[yt2].forEach(function(wt) {
                              U.set(wt, "dummy" + yt2), J.get("dummy" + yt2).push(wt), F.has(wt) && nt.add("dummy" + yt2);
                            }), at.set("dummy" + yt2, L[d.get(Mt[yt2][0])]);
                          }, xt = 0; xt < Mt.length; xt++)
                            pt(xt);
                      }
                      var lt = /* @__PURE__ */ new Map(), ot = /* @__PURE__ */ new Map(), Lt = function(yt2) {
                        W.get(yt2).forEach(function(wt) {
                          var Zt = void 0, $t = void 0;
                          wt.direction == "horizontal" ? (Zt = b.get(yt2) ? b.get(yt2) : yt2, b.get(wt.id) ? $t = { id: b.get(wt.id), gap: wt.gap, direction: wt.direction } : $t = wt, lt.has(Zt) ? lt.get(Zt).push($t) : lt.set(Zt, [$t]), lt.has($t.id) || lt.set($t.id, [])) : (Zt = U.get(yt2) ? U.get(yt2) : yt2, U.get(wt.id) ? $t = { id: U.get(wt.id), gap: wt.gap, direction: wt.direction } : $t = wt, ot.has(Zt) ? ot.get(Zt).push($t) : ot.set(Zt, [$t]), ot.has($t.id) || ot.set($t.id, []));
                        });
                      }, ft = true, st = false, Xt2 = void 0;
                      try {
                        for (var Tt = W.keys()[Symbol.iterator](), Ct; !(ft = (Ct = Tt.next()).done); ft = true) {
                          var Bt = Ct.value;
                          Lt(Bt);
                        }
                      } catch (Gt) {
                      ...
                      var bt = E(lt), zt = E(ot), St = n(bt), kt = n(zt), Kt = p(lt), he = p(ot), Qt = [], jt = [];
                      St.forEach(function(Gt, yt2) {
                        Qt[yt2] = [], Gt.forEach(function(wt) {
                          Kt.get(wt).length == 0 && Qt[yt2].push(wt);
                        });
                      }), kt.forEach(function(Gt, yt2) {
                        jt[yt2] = [], Gt.forEach(function(wt) {
                          he.get(wt).length == 0 && jt[yt2].push(wt);
                        });
                      });
                      var _t = O(lt, "horizontal", ct, k, Qt), Jt = O(ot, "vertical", nt, at, jt), oe = function(yt2) {
                        $.get(yt2) ? $.get(yt2).forEach(function(wt) {
                          v[d.get(wt)] = _t.get(yt2);
                        }) : v[d.get(yt2)] = _t.get(yt2);
                      }, te = true, ee = false, Ne = void 0;
                      try {
                        for (var le = _t.keys()[Symbol.iterator](), Le; !(te = (Le = le.next()).done); te = true) {
                          var fe = Le.value;
                          oe(fe);
                        }
                      } catch (Gt) {
                      ...
                      var $e = function(yt2) {
                        J.get(yt2) ? J.get(yt2).forEach(function(wt) {
                          L[d.get(wt)] = Jt.get(yt2);
                        }) : L[d.get(yt2)] = Jt.get(yt2);
                      }, ce = true, Ce = false, Ae = void 0;
                      try {
                        for (var ge = Jt.keys()[Symbol.iterator](), Me; !(ce = (Me = ge.next()).done); ce = true) {
                          var fe = Me.value;
                          $e(fe);
                        }
                      } catch (Gt) {
        ...
        var P = {
          ...
          548: (
            ...
            (a, r, e) => {
              var f = function() {
                function t(o, s) {
                  var c = [], l = true, T = false, d = void 0;
                  try {
                    for (var v = o[Symbol.iterator](), L; !(l = (L = v.next()).done) && (c.push(L.value), !(s && c.length === s)); l = true)
                      ;
                  } catch (S) {
                    T = true, d = S;
                  } finally {
              ...
              g.getTopMostNodes = function(t) {
                ...
                var l = new i(), T = /* @__PURE__ */ new Set(), d = [], v = void 0, L = void 0, S = void 0, C = false, G = 1, K = [], X = [], Q = function() {
                  var rt = t.collection();
                  X.push(rt);
                  var n = s[0], E = t.collection();
                  E.merge(n).merge(n.descendants().intersection(o)), d.push(n), E.forEach(function(y) {
                  ...
                  for (var p = function() {
                    ...
                    n.neighborhood().nodes().forEach(function(x) {
                      o.intersection(n.edgesWith(x)).length > 0 && R2.merge(x);
                    });
                    for (var M = 0; M < R2.length; M++) {
                      var F = R2[M];
                  ...
                  if (rt.forEach(function(y) {
                    o.intersection(y.connectedEdges()).forEach(function(R2) {
                      rt.has(R2.source()) && rt.has(R2.target()) && rt.merge(R2);
                    });
                    ...
                    var m2 = t.collection();
                    m2.merge(d[0]), d.forEach(function(y) {
                      m2.merge(y);
                    }), d = [], s = s.difference(m2), G++;
                  }
                };
                do
                  Q();
                  ...
                  if (s.quality == "draft") {
                    ...
                    try {
                      for (var C = o.nodeIndexes[Symbol.iterator](), G; !(v = (G = C.next()).done); v = true) {
                        ...
                        if (rt) {
                          var n = rt.boundingBox(), E = o.xCoords[O] - n.w / 2, p = o.xCoords[O] + n.w / 2, m2 = o.yCoords[O] - n.h / 2, y = o.yCoords[O] + n.h / 2;
                          E < c && (c = E), p > l && (l = p), m2 < T && (T = m2), y > d && (d = y);
                        }
                      }
                    } catch (x) {
                      L = true, S = x;
            ...
            (a, r, e) => {
              var f = e(548), i = e(140).CoSELayout, g = e(140).CoSENode, t = e(140).layoutBase.PointD, o = e(140).layoutBase.DimensionD, s = e(140).layoutBase.LayoutConstants, c = e(140).layoutBase.FDLayoutConstants, l = e(140).CoSEConstants, T = function(v, L) {
                ...
                var n = function(x) {
                  ...
                  return n(x) ? x(Z) : x;
                }, p = f.calcParentsWithoutChildren(S, C), m2 = function W(x, Z, V, Y) {
                  ...
                  for (var Y = 0, et = 0, z = 0; z < V.length; z++) {
                    ...
                    if (H && B && H !== B && H.getEdgesBetween(B).length == 0) {
                      ...
                      _.id = w.id(), _.idealLength = E(v.idealEdgeLength, w), _.edgeElasticity = E(v.edgeElasticity, w), Y += _.idealLength, et++;
                    }
                  }
              ...
              var g = e(658), t = e(548), o = e(657), s = o.spectralLayout, c = e(816), l = c.coseLayout, T = Object.freeze({
                ...
                return f(v, [{
                  ...
                  value: function() {
                    ...
                    var E = void 0, p = false;
                    if (G.layoutUtilities && C.packComponents && (E = G.layoutUtilities("get"), E || (E = G.layoutUtilities()), p = true), K.nodes().length > 0)
                      if (p) {
                        var R2 = t.getTopMostNodes(C.eles.nodes());
                        if (O = t.connectComponents(G, C.eles, R2), O.forEach(function(vt) {
                          ...
                          if (C.tile) {
                            ...
                            if (O.forEach(function(vt, it) {
                              vt.edges().length == 0 && (vt.nodes().forEach(function(gt2, Et) {
                                M.merge(vt.nodes()[Et]), gt2.isParent() || (V.nodeIndexes.set(vt.nodes()[Et].id(), Z++), V.xCoords.push(vt.nodes()[0].position().x), V.yCoords.push(vt.nodes()[0].position().y));
                              }), Y.push(it));
                            }), M.length > 1) {
                        ...
                        if (O.length > 1) {
                          ...
                          O.forEach(function(vt, it) {
                            var gt2 = void 0;
                            if (C.quality == "draft" && (gt2 = X[it].nodeIndexes), vt.nodes().not(B).length > 0) {
                              var Et = {};
                              Et.edges = [], Et.nodes = [];
                              var At = void 0;
                              vt.nodes().not(B).forEach(function(Ot) {
                                if (C.quality == "draft")
                                  if (!Ot.isParent())
                                    At = gt2.get(Ot.id()), Et.nodes.push({ x: X[it].xCoords[At] - Ot.boundingbox().w / 2, y: X[it].yCoords[At] - Ot.boundingbox().h / 2, width: Ot.boundingbox().w, height: Ot.boundingbox().h });
                                  else {
                                    var mt = t.calcBoundingBox(Ot, X[it].xCoords, X[it].yCoords, gt2);
                                    Et.nodes.push({ x: mt.topLeftX, y: mt.topLeftY, width: mt.width, height: mt.height });
                                  }
                                else
                                  Q[it][Ot.id()] && Et.nodes.push({ x: Q[it][Ot.id()].getLeft(), y: Q[it][Ot.id()].getTop(), width: Q[it][Ot.id()].getWidth(), height: Q[it][Ot.id()].getHeight() });
                              }), vt.edges().forEach(function(Ot) {
                                var mt = Ot.source(), Dt = Ot.target();
                                if (mt.css("display") != "none" && Dt.css("display") != "none")
                                  if (C.quality == "draft") {
                                    var Rt = gt2.get(mt.id()), Ht = gt2.get(Dt.id()), Ut = [], Pt = [];
                                    if (mt.isParent()) {
                                      var Ft = t.calcBoundingBox(mt, X[it].xCoords, X[it].yCoords, gt2);
                                      Ut.push(Ft.topLeftX + Ft.width / 2), Ut.push(Ft.topLeftY + Ft.height / 2);
                                    } else
                                      Ut.push(X[it].xCoords[Rt]), Ut.push(X[it].yCoords[Rt]);
                                    if (Dt.isParent()) {
                                      var Yt = t.calcBoundingBox(Dt, X[it].xCoords, X[it].yCoords, gt2);
                                    ...
                                    Q[it][mt.id()] && Q[it][Dt.id()] && Et.edges.push({ startX: Q[it][mt.id()].getCenterX(), startY: Q[it][mt.id()].getCenterY(), endX: Q[it][Dt.id()].getCenterX(), endY: Q[it][Dt.id()].getCenterY() });
                              }), Et.nodes.length > 0 && (H.push(Et), w.add(it));
                            }
                          });
                          var _ = E.packComponents(H, C.randomize).shifts;
                          if (C.quality == "draft")
                            X.forEach(function(vt, it) {
                              var gt2 = vt.xCoords.map(function(At) {
                                return At + _[it].dx;
                              }), Et = vt.yCoords.map(function(At) {
                                return At + _[it].dy;
                              });
                              vt.xCoords = gt2, vt.yCoords = Et;
                            });
                          else {
                            var ht = 0;
                            w.forEach(function(vt) {
                              Object.keys(Q[vt]).forEach(function(it) {
                                var gt2 = Q[vt][it];
                                gt2.setCenter(gt2.getCenterX() + _[ht].dx, gt2.getCenterY() + _[ht].dy);
                              }), ht++;
                            });
                          }
                        }
                      } else {
                        var m2 = C.eles.boundingBox();
                        if (rt.push({ x: m2.x1 + m2.w / 2, y: m2.y1 + m2.h / 2 }), C.randomize) {
                          var y = s(C);
                          X.push(y);
                        }
                        C.quality == "default" || C.quality == "proof" ? (Q.push(l(C, X[0])), t.relocateComponent(rt[0], Q[0], C)) : t.relocateComponent(rt[0], X[0], C);
                      }
                    var q = function(it, gt2) {
                      if (C.quality == "default" || C.quality == "proof") {
                        typeof it == "number" && (it = gt2);
                        var Et = void 0, At = void 0, Ot = it.data("id");
                        return Q.forEach(function(Dt) {
                          Ot in Dt && (Et = { x: Dt[Ot].getRect().getCenterX(), y: Dt[Ot].getRect().getCenterY() }, At = Dt[Ot]);
                        }), C.nodeDimensionsIncludeLabels && (At.labelWidth && (At.labelPosHorizontal == "left" ? Et.x += At.labelWidth / 2 : At.labelPosHorizontal == "right" && (Et.x -= At.labelWidth / 2)), At.labelHeight && (At.labelPosVertical == "top" ? Et.y += At.labelHeight / 2 : At.labelPosVertical == "bottom" && (Et.y -= At.labelHeight / 2))), Et == null && (Et = { x: it.position("x"), y: it.position("y") }), {
                          x: Et.x,
                          y: Et.y
                        };
                      } else {
                        ...
                        return X.forEach(function(Dt) {
                          ...
                          Rt != null && (mt = { x: Dt.xCoords[Rt], y: Dt.yCoords[Rt] });
          ...
          657: (
            ...
            (a, r, e) => {
              var f = e(548), i = e(140).layoutBase.Matrix, g = e(140).layoutBase.SVD, t = function(s) {
                var c = s.cy, l = s.eles, T = l.nodes(), d = l.nodes(":parent"), v = /* @__PURE__ */ new Map(), L = /* @__PURE__ */ new Map(), S = /* @__PURE__ */ new Map(), C = [], G = [], K = [], X = [], Q = [], O = [], rt = [], n = [], E = void 0, p = 1e8, m2 = 1e-9, y = s.piTol, R2 = s.samplingType, M = s.nodeSeparation, F = void 0, W = function() {
                  for (var U = 0, $ = 0, J = false; $ < F; ) {
                    U = Math.floor(Math.random() * E), J = false;
                    for (var k = 0; k < $; k++)
                      if (X[k] == U) {
                        J = true;
                        break;
                  ...
                  for (var k = [], at = 0, ct = 0, nt = 0, tt = void 0, j = [], ut = 0, Mt = 1, pt = 0; pt < E; pt++)
                    j[pt] = p;
                  ...
                  for (var U = void 0, $ = void 0, J = [], k = [], at = [], ct = [], nt = 0; nt < E; nt++)
                    J[nt] = Math.random(), k[nt] = Math.random();
                  J = i.normalize(J), k = i.normalize(k);
                  for (var tt = m2, j = m2, ut = void 0; ; ) {
                ...
                var w = true, H = false, B = void 0;
                try {
                  for (var _ = v.keys()[Symbol.iterator](), ht; !(w = (ht = _.next()).done); w = true) {
                    var q = ht.value;
                    L.set(q, et++);
                  }
                } catch (b) {
                ...
                }, vt = true, it = false, gt2 = void 0;
                try {
                  for (var Et = v.keys()[Symbol.iterator](), At; !(vt = (At = Et.next()).done); vt = true) {
                    var Ot = At.value;
                    Nt(Ot);
                  }
                } catch (b) {
...
var De = {
  ...
  L: /* @__PURE__ */ m((I) => `${I},${I / 2} 0,${I} 0,0`, "L"),
  R: /* @__PURE__ */ m((I) => `0,${I / 2} ${I},0 ${I},${I}`, "R"),
  T: /* @__PURE__ */ m((I) => `0,0 ${I},0 ${I / 2},${I}`, "T"),
  B: /* @__PURE__ */ m((I) => `${I / 2},0 ${I},${I} 0,${I}`, "B")
}, se = {
  L: /* @__PURE__ */ m((I, D) => I - D + 2, "L"),
  R: /* @__PURE__ */ m((I, D) => I - 2, "R"),
  T: /* @__PURE__ */ m((I, D) => I - D + 2, "T"),
  B: /* @__PURE__ */ m((I, D) => I - 2, "B")
}, pr = /* @__PURE__ */ m(function(I) {
  return Wt(I) ? I === "L" ? "R" : "L" : I === "T" ? "B" : "T";
}, "getOppositeArchitectureDirection"), Ie = /* @__PURE__ */ m(function(I) {
  const D = I;
  return D === "L" || D === "R" || D === "T" || D === "B";
}, "isArchitectureDirection"), Wt = /* @__PURE__ */ m(function(I) {
  const D = I;
  return D === "L" || D === "R";
}, "isArchitectureDirectionX"), qt = /* @__PURE__ */ m(function(I) {
  const D = I;
  return D === "T" || D === "B";
}, "isArchitectureDirectionY"), Te = /* @__PURE__ */ m(function(I, D) {
  const A = Wt(I) && qt(D), P = qt(I) && Wt(D);
  return A || P;
}, "isArchitectureDirectionXY"), yr = /* @__PURE__ */ m(function(I) {
  const D = I[0], A = I[1], P = Wt(D) && qt(A), N = qt(D) && Wt(A);
  return P || N;
}, "isArchitecturePairXY"), mr = /* @__PURE__ */ m(function(I) {
  return I !== "LL" && I !== "RR" && I !== "TT" && I !== "BB";
}, "isValidArchitectureDirectionPair"), pe = /* @__PURE__ */ m(function(I, D) {
  const A = `${I}${D}`;
  return mr(A) ? A : void 0;
}, "getArchitectureDirectionPair"), Er = /* @__PURE__ */ m(function([I, D], A) {
  const P = A[0], N = A[1];
  return Wt(P) ? qt(N) ? [I + (P === "L" ? -1 : 1), D + (N === "T" ? 1 : -1)] : [I + (P === "L" ? -1 : 1), D] : Wt(N) ? [I + (N === "L" ? 1 : -1), D + (P === "T" ? 1 : -1)] : [I, D + (P === "T" ? 1 : -1)];
}, "shiftPositionByArchitectureDirectionPair"), Tr = /* @__PURE__ */ m(function(I) {
  return I === "LT" || I === "TL" ? [1, 1] : I === "BL" || I === "LB" ? [1, -1] : I === "BR" || I === "RB" ? [-1, -1] : [-1, 1];
}, "getArchitectureDirectionXYFactors"), Nr = /* @__PURE__ */ m(function(I, D) {
  return Te(I, D) ? "bend" : Wt(I) ? "horizontal" : "vertical";
}, "getArchitectureDirectionAlignment"), Lr = /* @__PURE__ */ m(function(I) {
  return I.type === "service";
}, "isArchitectureService"), Cr = /* @__PURE__ */ m(function(I) {
  return I.type === "junction";
}, "isArchitectureJunction"), be = /* @__PURE__ */ m((I) => I.data(), "edgeData"), ie = /* @__PURE__ */ m((I) => I.data(), "nodeData"), Ar = Lf.architecture, ne, Pe = (ne = class {
  constructor() {
    this.nodes = {}, this.groups = {}, this.edges = [], this.registeredIds = {}, this.elements = {}, this.setAccTitle = $5, this.getAccTitle = B5, this.setDiagramTitle = R5, this.getDiagramTitle = I5, this.getAccDescription = D5, this.setAccDescription = F5, this.clear();
  }
  clear() {
    this.nodes = {}, this.groups = {}, this.edges = [], this.registeredIds = {}, this.dataStructures = void 0, this.elements = {}, M5();
  }
  addService({
    id: D,
    icon: A,
...
}, m(ne, "ArchitectureDB"), ne), Mr = /* @__PURE__ */ m((I, D) => {
  m$1(I, D), I.groups.map((A) => D.addGroup(A)), I.services.map((A) => D.addService({ ...A, type: "service" })), I.junctions.map((A) => D.addJunction({ ...A, type: "junction" })), I.edges.map((A) => D.addEdge(A));
}, "populateDb"), Ge = {
  parser: {
    // @ts-expect-error - ArchitectureDB is not assignable to DiagramDB
    yy: void 0
  },
  parse: /* @__PURE__ */ m(async (I) => {
    var P;
    const D = await Yy("architecture", I);
    R.debug(D);
...
`, "getStyles"), Or = wr, re = /* @__PURE__ */ m((I) => `<g><rect width="80" height="80" style="fill: #087ebf; stroke-width: 0px;"/>${I}</g>`, "wrapIcon"), ae = {
...
}, Dr = /* @__PURE__ */ m(async function(I, D, A) {
  ...
  await Promise.all(
    D.edges().map(async (r) => {
      ...
      if (g && (Wt(f) ? T += f === "L" ? -G : G : d += f === "T" ? -G : G + 18), c && (Wt(o) ? S += o === "L" ? -G : G : C += o === "T" ? -G : G + 18), !g && ((K = A.getNode(e)) == null ? void 0 : K.type) === "junction" && (Wt(f) ? T += f === "L" ? u : -u : d += f === "T" ? u : -u), !c && ((X = A.getNode(t)) == null ? void 0 : X.type) === "junction" && (Wt(o) ? S += o === "L" ? u : -u : C += o === "T" ? u : -u), r[0]._private.rscratch) {
        const Q = I.insert("g");
        if (Q.insert("path").attr("d", `M ${T},${d} L ${v},${L} L${S},${C} `).attr("class", "edge").attr("id", OI(e, t, { prefix: "L" })), i) {
        ...
        if (l) {
          ...
          if (await Ar$1(
            ...
            const E = pe(f, o);
            if (E && yr(E)) {
              const p = n.node().getBoundingClientRect(), [m2, y] = Tr(E);
              n.attr("dominant-baseline", "auto").attr("transform", `rotate(${-1 * m2 * y * 45})`);
              const R2 = n.node().getBoundingClientRect();
              n.attr(
                "transform",
                `
                translate(${v}, ${L - p.height / 2})
                translate(${m2 * R2.width / 2}, ${y * R2.height / 2})
                rotate(${-1 * m2 * y * 45}, 0, ${p.height / 2})
              `
              );
            }
          }
...
}, "drawEdges"), xr = /* @__PURE__ */ m(async function(I, D, A) {
    ...
    D.nodes().map(async (r) => {
      ...
      if (e.type === "group") {
        ...
        if (e.icon) {
          const T = s.append("g");
          T.html(
            `<g>${await aa(e.icon, { height: N, width: N, fallbackPrefix: ae.prefix })}</g>`
          ), T.attr(
            "transform",
...
}, "drawGroups"), Ir = /* @__PURE__ */ m(async function(I, D, A) {
  const P = yt();
  for (const N of A) {
    ...
    if (N.icon)
      a.html(
        `<g>${await aa(N.icon, { height: h, width: h, fallbackPrefix: ae.prefix })}</g>`
      );
    else if (N.iconText) {
      a.html(
        `<g>${await aa("blank", { height: h, width: h, fallbackPrefix: ae.prefix })}</g>`
      );
      const g = a.append("g").append("foreignObject").attr("width", h).attr("height", h).append("div").attr("class", "node-icon-text").attr("style", `height: ${h}px;`).append("div").html(_e(N.iconText, P)), t = parseInt(
  ...
  return 0;
}, "drawServices"), Rr = /* @__PURE__ */ m(function(I, D, A) {
  A.forEach((P) => {
...
m(We, "addEdges");
function Ve(I, D, A) {
  const P = /* @__PURE__ */ m((a, r) => Object.entries(a).reduce(
    (e, [f, i]) => {
      var o;
      let g = 0;
...
m(Ve, "getAlignments");
function ze(I, D) {
  const A = [], P = /* @__PURE__ */ m((u) => `${u[0]},${u[1]}`, "posToStr"), N = /* @__PURE__ */ m((u) => u.split(",").map((h) => parseInt(h)), "strToPos");
  return I.forEach((u) => {
...
m(ze, "getRelativeConstraints");
function Be(I, D, A, P, N, { spatialMaps: u, groupAlignments: h }) {
  return new Promise((a) => {
    const r = gt("body").append("div").attr("id", "cy").attr("style", "display:none"), e = ea({
    ...
    g.one("layoutstop", () => {
      ...
      m(t, "getSegmentWeights"), e.startBatch();
...
m(Be, "layoutArchitecture");
var Sr = /* @__PURE__ */ m(async (I, D, A, P) => {
  const N = P.db, u = N.getServices(), h = N.getJunctions(), a = N.getGroups(), r = N.getEdges(), e = N.getDataStructures(), f = bT(D), i = f.append("g");
  ...
  await Dr(i, o, N), await xr(t, o, N), Xe(N, o), T5(void 0, f, N.getConfigField("padding"), N.getConfigField("useMaxWidth"));
}, "draw"), Fr = { draw: Sr }, ha = {
  parser: Ge,
  get db() {
    return new Pe();
