...
import { H as m, aw as Pv, K as R, O as yt, at as RI, au as DI, a6 as gt, aq as $e, a7 as b5, a8 as x5, aa as y5, a9 as w5, ak as k5, al as _5, ar as m5, ap as CI, av as dn } from "./app-254b8ee7.js";
...
var Xt = pt, K, qt = (K = class {
  constructor() {
    ...
    }, this.setAccTitle = b5, this.getAccTitle = x5, this.setAccDescription = y5, this.getAccDescription = w5, this.setDiagramTitle = k5, this.getDiagramTitle = _5, this.getConfig = /* @__PURE__ */ m(() => yt().er, "getConfig"), this.clear(), this.addEntity = this.addEntity.bind(this), this.addAttributes = this.addAttributes.bind(this), this.addRelationship = this.addRelationship.bind(this), this.setDirection = this.setDirection.bind(this), this.addCssStyles = this.addCssStyles.bind(this), this.addClass = this.addClass.bind(this), this.setClass = this.setClass.bind(this), this.setAccTitle = this.setAccTitle.bind(this), this.setAccDescription = this.setAccDescription.bind(this);
  }
  /**
   * Add entity
...
var Ht = /* @__PURE__ */ m(async function(i, s, h, p) {
  ...
  f.type = p.type, f.layoutAlgorithm = RI(y), f.config.flowchart.nodeSpacing = (c == null ? void 0 : c.nodeSpacing) || 140, f.config.flowchart.rankSpacing = (c == null ? void 0 : c.rankSpacing) || 80, f.direction = p.db.getDirection(), f.markers = ["only_one", "zero_or_one", "one_or_more", "zero_or_more"], f.diagramId = s, await DI(f, E), f.layoutAlgorithm === "elk" && E.select(".edges").lower();
