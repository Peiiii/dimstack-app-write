...
class L {
  ...
  setDefaultNodeLabel(e) {
    return Jc(e) || (e = dL(e)), this._defaultNodeLabelFn = e, this;
  }
  nodeCount() {
    return this._nodeCount;
  }
  nodes() {
    return O$1(this._nodes);
  }
  sources() {
    var e = this;
    return Rt(this.nodes(), function(t) {
      return Zd(e._in[t]);
    });
  }
  sinks() {
  ...
  removeNode(e) {
    if (Object.prototype.hasOwnProperty.call(this._nodes, e)) {
      ...
      delete this._nodes[e], this._isCompound && (this._removeFromParentsChildList(e), delete this._parent[e], Mt(this.children(e), (s) => {
        this.setParent(s);
      }), delete this._children[e]), Mt(O$1(this._in[e]), t), delete this._in[e], delete this._preds[e], Mt(O$1(this._out[e]), t), delete this._out[e], delete this._sucs[e], --this._nodeCount;
    }
    return this;
  }
  setParent(e, t) {
    ...
    if (Dt(t))
      ...
      t += "";
      for (var s = t; !Dt(s); s = this.parent(s))
        if (s === e)
  ...
  filterNodes(e) {
    ...
    var s = this;
    Mt(this._nodes, function(n, h) {
      e(h) && t.setNode(h, n);
    }), Mt(this._edgeObjs, function(n) {
    ...
    return this._isCompound && Mt(t.nodes(), function(n) {
      t.setParent(n, r(n));
    }), t;
  }
  /* === Edge functions ========== */
  setDefaultEdgeLabel(e) {
    return Jc(e) || (e = dL(e)), this._defaultEdgeLabelFn = e, this;
  }
  edgeCount() {
    return this._edgeCount;
  }
  edges() {
    return Ft(this._edgeObjs);
  }
  setPath(e, t) {
    var s = this, i = arguments;
    return mt(e, function(r, n) {
  ...
  setEdge() {
    ...
    typeof n == "object" && n !== null && "v" in n ? (e = n.v, t = n.w, s = n.name, arguments.length === 2 && (i = arguments[1], r = true)) : (e = n, t = arguments[1], s = arguments[3], arguments.length > 2 && (i = arguments[2], r = true)), e = "" + e, t = "" + t, Dt(s) || (s = "" + s);
