import { H as m, aQ as J6, az as Xt, ay as lu, ax as Lf, aR as ZM, M as R, aS as lT, ag as _e, al as I5, a7 as $5, a8 as B5, ak as R5, a9 as D5, aa as F5, ar as M5, aK as bT, ah as Of } from "./app-33e0c163.js";
...
var J, Ht = (J = class {
  ...
  getMaxDimension(t2, i) {
    ...
    for (const r of t2) {
      const g = ZM(n, 1, r), m2 = g ? g.width : r.length * i, f = g ? g.height : i;
...
var nt, Li = (nt = class {
  ...
  getDrawableElement() {
    ...
    let i;
    return this.orientation === "horizontal" ? i = lT().y((s) => s[0]).x((s) => s[1])(t2) : i = lT().x((s) => s[0]).y((s) => s[1])(t2), i ? [
      {
...
function ni() {
  ...
  return A.title = I5(), Vi.build(K, A, Z, Gt);
}
...
` + e);
  const C = bT(t2), b = C.append("g").attr("class", "main"), E = b.append("rect").attr("width", g.width).attr("height", g.height).attr("class", "background");
