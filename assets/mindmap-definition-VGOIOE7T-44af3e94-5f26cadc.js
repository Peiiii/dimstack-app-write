...
import { H as m, K as R, O as yt, ax as Mf, ag as _e$1, bB as lI, at as RI, au as DI, bl as Kn, bm as Y$1, bn as et } from "./app-254b8ee7.js";
...
var De = q, x = {
   ...
   */
  getData() {
    const e = this.getMindmap(), i = yt(), g2 = lI().layout !== void 0, l = i;
...
` + t);
  ...
  l.type = c.type, l.layoutAlgorithm = RI(l.config.layout, {
    ...
    u,
    ((_ = l.config.mindmap) == null ? void 0 : _.padding) ?? Mf.mindmap.padding,
    "mindmapDiagram",
    ((b = l.config.mindmap) == null ? void 0 : b.useMaxWidth) ?? Mf.mindmap.useMaxWidth
  ));
}, "draw"), Le = {
  draw: ke
}, xe = /* @__PURE__ */ m((t) => {
