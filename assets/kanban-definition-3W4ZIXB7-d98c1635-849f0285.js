import { H as m$1, M as R, O as yt, aK as bT, a1 as k$, Y as Nb, a0 as YI, bk as T5, ax as Lf, ag as _e, am as vA, an as CA, bl as Kn, bm as Y, bn as et } from "./app-ac489121.js";
...
var xe = $, D = [], ie = [], ee = 0, ne = {}, ve = /* @__PURE__ */ m$1(() => {
  ...
  var C, w;
  const E = yt();
  let f = ((C = E.mindmap) == null ? void 0 : C.padding) ?? Lf.mindmap.padding;
  switch (s) {
    case m.ROUNDED_RECT:
    case m.RECT:
    case m.HEXAGON:
  ...
  const h = {
    ...
    level: t,
    label: _e(g, E),
    width: ((w = E.mindmap) == null ? void 0 : w.maxNodeWidth) ?? Lf.mindmap.maxNodeWidth,
    padding: f,
    isGroup: false
  };
  if (d !== void 0) {
...
` + t);
  ...
  for (const b of w) {
    ...
    for (const e of a) {
      ...
      e.y = i + l2.height / 2, await YI(e), i = e.y + l2.height / 2 + r / 2;
    }
  ...
  T5(
    void 0,
    h,
    ((j = f.mindmap) == null ? void 0 : j.padding) ?? Lf.kanban.padding,
    ((V = f.mindmap) == null ? void 0 : V.useMaxWidth) ?? Lf.kanban.useMaxWidth
  );
}, "draw"), Fe = {
  draw: Be
}, Ge = /* @__PURE__ */ m$1((t) => {
