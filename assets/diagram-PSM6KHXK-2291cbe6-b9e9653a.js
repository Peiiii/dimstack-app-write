import { H as m, a7 as b5, a8 as x5, ak as k5, al as _5, a9 as w5, aa as y5, az as Xt, ay as lu, bQ as mm, ar as m5, K as R, ax as Mf, aK as iT, ah as Of, bR as X, a6 as gt } from "./app-254b8ee7.js";
...
var q, ne = (q = class {
  constructor() {
    this.nodes = [], this.levels = /* @__PURE__ */ new Map(), this.outerNodes = [], this.classes = /* @__PURE__ */ new Map(), this.setAccTitle = b5, this.getAccTitle = x5, this.setDiagramTitle = k5, this.getDiagramTitle = _5, this.getAccDescription = w5, this.setAccDescription = y5;
  }
  getNodes() {
    return this.nodes;
  }
