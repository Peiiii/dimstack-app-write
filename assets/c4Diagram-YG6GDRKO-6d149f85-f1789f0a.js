import { o, y } from "./chunk-TZMSLE5B-ee953cb1-f43091ee.js";
import { H as m, a7 as b5, a8 as x5, a9 as w5, aa as y5, O as yt, ab as Dt, ac as vM, ad as Ii, ae as Nm, af as ur, ag as _e$1, a6 as gt, K as R, ah as Of, ai as bm } from "./app-254b8ee7.js";
...
var Ue = Ft, V = [], _t = [""], B = "global", F = "", X = [
  ...
  ], F = "", B = "global", _t = [""], Pt = [], _t = [""], ae = "", re = false, Vt = 4, zt = 2;
}, "clear"), u0 = {
  SOLID: 0,
  DOTTED: 1,
  NOTE: 2,
...
function j(e, t, s, o2, l) {
  if (!t[e].width)
    if (s)
      t[e].text = vM(t[e].text, l, o2), t[e].textLines = t[e].text.split(Ii.lineBreakRegex).length, t[e].width = l, t[e].height = Nm(t[e].text, o2);
    else {
...
function se(e, t, s, o2, l) {
  ...
  for (let [n, r] of o2.entries()) {
    ...
    E.length > 0 && se(
      ...
      E,
      l
    ), r.alias !== "global" && ke(e, r, i), s.data.stopy = Math.max(
