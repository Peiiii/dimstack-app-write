...
import { H as m, O as yt, K as R, a6 as gt$1, ag as _e, bC as Om, az as Xt$1, bD as It$1, bE as Ar$1, Z as Kc, aq as $e$1, bF as hA, aS as V8, a_ as n5, ah as Of, ar as m5, av as dn, b2 as qa, bG as h1, bH as ri, ad as Ii } from "./app-254b8ee7.js";
...
var dr = /* @__PURE__ */ m((e2, t) => {
  ...
  const { x: L2, y: E } = hA(a2), D = V8().x(L2).y(E).curve(m2);
  let v;
  switch (a2.thickness) {
    case "normal":
  ...
  let k = "";
  (yt().flowchart.arrowMarkerAbsolute || yt().state.arrowMarkerAbsolute) && (k = n5(true)), cr(T, a2, k, r, l2);
  let N = {};
