import { a4 as Dv, ax as Mf, H as m, bN as FL, bO as DL, a5 as Rv, a7 as b5, a8 as x5, ak as k5, al as _5, a9 as w5, aa as y5, ar as m5, ay as lu, az as Xt, K as R, a6 as gt, aK as iT, bk as d5, ap as CI, bE as Ar$1, O as yt, bP as aa, ag as _e } from "./app-254b8ee7.js";
...
}, "isArchitectureJunction"), be = /* @__PURE__ */ m((I) => I.data(), "edgeData"), ie = /* @__PURE__ */ m((I) => I.data(), "nodeData"), Ar = Mf.architecture, ne, Pe = (ne = class {
  constructor() {
    this.nodes = {}, this.groups = {}, this.edges = [], this.registeredIds = {}, this.elements = {}, this.setAccTitle = b5, this.getAccTitle = x5, this.setDiagramTitle = k5, this.getDiagramTitle = _5, this.getAccDescription = w5, this.setAccDescription = y5, this.clear();
  }
  clear() {
  ...
  await Promise.all(
    D.edges().map(async (r) => {
      ...
      if (g && (Wt(f) ? T += f === "L" ? -G : G : d += f === "T" ? -G : G + 18), c && (Wt(o) ? S += o === "L" ? -G : G : C += o === "T" ? -G : G + 18), !g && ((K = A.getNode(e)) == null ? void 0 : K.type) === "junction" && (Wt(f) ? T += f === "L" ? u : -u : d += f === "T" ? u : -u), !c && ((X = A.getNode(t)) == null ? void 0 : X.type) === "junction" && (Wt(o) ? S += o === "L" ? u : -u : C += o === "T" ? u : -u), r[0]._private.rscratch) {
        const Q = I.insert("g");
        if (Q.insert("path").attr("d", `M ${T},${d} L ${v},${L} L${S},${C} `).attr("class", "edge").attr("id", CI(e, t, { prefix: "L" })), i) {
...
var Sr = /* @__PURE__ */ m(async (I, D, A, P) => {
  const N = P.db, u = N.getServices(), h = N.getJunctions(), a = N.getGroups(), r = N.getEdges(), e = N.getDataStructures(), f = iT(D), i = f.append("g");
  ...
  await Dr(i, o, N), await xr(t, o, N), Xe(N, o), d5(void 0, f, N.getConfigField("padding"), N.getConfigField("useMaxWidth"));
}, "draw"), Fr = { draw: Sr }, ha = {
  parser: Ge,
  get db() {
    return new Pe();
