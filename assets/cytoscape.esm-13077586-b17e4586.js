...
function tc(r, e) {
  for (var t = 0; t < e.length; t++) {
    var a = e[t];
    a.enumerable = a.enumerable || false, a.configurable = true, "value" in a && (a.writable = true), Object.defineProperty(r, jl(a.key), a);
  }
}
function gt(r, e, t) {
...
var uc = ar(""), ev = ar({}), lc = ar(function() {
  ...
  return t;
}, Ka = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof window < "u" ? window : typeof self < "u" ? self : {};
function Oa(r) {
...
function zc() {
  if (Fo)
    return vi;
  Fo = 1;
  var r = Lc(), e = Na(), t = za(), a = 0 / 0, n = /^[-+]0x[0-9a-f]+$/i, i = /^0b[01]+$/i, s = /^0o[0-7]+$/i, o = parseInt;
  function l(u) {
    if (typeof u == "number")
      return u;
    if (t(u))
...
function Fc() {
  ...
  function s(o, l, u) {
    var v, f, c, h, d, y, g = 0, p = false, m = false, b = true;
...
var _o = true, Uc = console.warn != null, Kc = console.trace != null, Js = Number.MAX_SAFE_INTEGER || 9007199254740991, dv = function() {
  return true;
}, xn = function() {
  return false;
}, Go = function() {
  ...
  return e = {
    ...
    for (var o = this._private.cy, l = a = ge(a) ? this.filter(a) : a, u = [], v = [], f = {}, c = {}, h = {}, d = 0, y, g = this.byGroup(), p = g.nodes, m = g.edges, b = 0; b < l.length; b++) {
      var w = l[b], E = w.id();
      w.isNode() && (u.unshift(w), e.bfs && (h[E] = true, v.push(w)), c[E] = 0);
    }
    for (var C = function() {
      ...
      for (var N = A.connectedEdges().filter(function(j) {
        ...
        Q.length !== 0 && !h[K] && (Q = Q[0], u.push(Q), e.bfs && (h[K] = true, v.push(Q)), f[K] = U, c[K] = c[R] + 1);
      }
...
var nd = ad(), Va = /* @__PURE__ */ Oa(nd), id = cr({
  ...
  bellmanFord: function(e) {
    var t = this, a = cd(e), n = a.weight, i = a.directed, s = a.root, o = n, l = this, u = this.cy(), v = this.byGroup(), f = v.edges, c = v.nodes, h = c.length, d = new Xr(), y = false, g = [];
    ...
    for (var k = false, D = function(we, ye, ie, de, he, Ee) {
      var pe = de.dist + Ee;
      pe < he.dist && !ie.same(de.edge) && (he.dist = pe, he.pred = we, he.edge = ie, k = true);
    }, B = 1; B < h; B++) {
      k = false;
      for (var P = 0; P < p; P++) {
    ...
    if (k)
      for (var V = [], G = 0; G < p; G++) {
        ...
        if (K + Q < j || !i && j + Q < K)
          if (y || (Ve("Graph contains a negative weight cycle for Bellman-Ford"), y = true), e.findNegativeWeightCycles !== false) {
            var re = [];
...
var wv = function(e, t, a, n, i, s, o) {
  ...
  if (c) {
    ...
    if (d = it(e, t, a, n, y, g, p, m, false), d.length > 0)
      return d;
  }
  if (h) {
    var b = a + v + o, w = n - f + u - o, E = b, C = n + f - u + o;
    if (d = it(e, t, a, n, b, w, E, C, false), d.length > 0)
      return d;
  }
  if (c) {
    var x = a - v + u - o, T = n + f + o, k = a + v - u + o, D = T;
    if (d = it(e, t, a, n, x, T, k, D, false), d.length > 0)
      return d;
  }
  if (h) {
    var B = a - v - o, P = n - f + u - o, A = B, R = n + f - u + o;
    if (d = it(e, t, a, n, B, P, A, R, false), d.length > 0)
      return d;
  }
  var L;
  {
  ...
  var u = [], v, f = new Array(a.length), c = true;
  s == null && (c = false);
  var h;
  if (c) {
  ...
  for (var h = 0; h < c.length / 4; h++)
    f = it(e, t, n, i, c[h * 4], c[h * 4 + 1], c[h * 4 + 2], c[h * 4 + 3], false), f.length !== 0 && v.push(f[0], f[1]);
  if (v.length > 2) {
...
var $d = cr({
  ...
  for (var m = true, b = 0; m && b < i.maxIterations; )
    m = false, f = Zd(v, l, i.expandFactor), v = Qd(f, l, i.inflateFactor), Jd(v, f, u, 4) || (m = true), b++;
  var w = jd(v, l, t, n);
  return w = rh(w), w;
}, th = {
  markovClustering: Zo,
...
var sh = cr({
  ...
  for (var u = true, v = 0; u && v < i.maxIterations; ) {
    ...
    for (var c = 0; c < i.k; c++) {
      ...
      if (h.length !== 0) {
        for (var d = i.attributes.length, y = l[c], g = new Array(d), p = new Array(d), m = 0; m < d; m++) {
          ...
          g[m] = p[m] / h.length, oh(g[m], y[m], i.sensitivityThreshold) || (u = true);
        }
  ...
  for (var f = true, c = 0; f && c < i.maxIterations; ) {
    for (var h = 0; h < a.length; h++)
    ...
    for (var d = 0; d < o.length; d++) {
      ...
      if (y.length !== 0) {
        ...
        for (var g = 0; g < y.length; g++)
          u = eu(y[g], y, i.attributes), u < v[d] && (v[d] = u, o[d] = y[g], f = true);
        s[d] = t.collection(y);
      }
    }
    c++;
  ...
  for (var m = true, b = 0; m && b < n.maxIterations; )
    m = false, ch(s, a, o, u, n), dh(o, l, s, a, n), uh(o, l, n.sensitivityThreshold) || (m = true), b++;
  return i = hh(a, o, n, t), {
    clusters: i,
  ...
  return d.key = y.key = d.index = y.index = null, true;
}, $t = function(e, t, a) {
  ...
  hierholzer: function(e) {
    ...
    var a = Dh(e), n = a.root, i = a.directed, s = this, o = false, l, u, v;
    n && (v = ge(n) ? this.filter(n)[0].id() : n[0].id());
    var f = {}, c = {};
    i ? s.forEach(function(m) {
      var b = m.id();
      if (m.isNode()) {
        var w = m.indegree(true), E = m.outdegree(true), C = w - E, x = E - w;
        C == 1 ? l ? o = true : l = b : x == 1 ? u ? o = true : u = b : (x > 1 || C > 1) && (o = true), f[b] = [], m.outgoers().forEach(function(T) {
      ...
      if (m.isNode()) {
        var w = m.degree(true);
        w % 2 && (l ? u ? o = true : u = b : l = b), f[b] = [], m.connectedEdges().forEach(function(E) {
    ...
    for (var p in f)
      if (f[p].length)
        return h;
    return h.found = true, h.trail = this.spawn(y, true), h;
  }
}, Qa = function() {
  var e = this, t = {}, a = 0, n = 0, i = [], s = [], o = {}, l = function(c, h) {
    ...
    if (y.size() === 0)
      ...
      y.forEach(function(w) {
        g = w.source().id(), p = w.target().id(), m = g === h ? p : g, m !== d && (b = w.id(), o[b] || (o[b] = true, s.push({
          x: h,
          y: m,
          edge: w
  ...
  var e = this, t = {}, a = 0, n = [], i = [], s = e.spawn(e), o = function(u) {
    ...
    if (v.forEach(function(y) {
      ...
      for (var f = e.spawn(); ; ) {
        var c = i.pop();
        if (f.merge(e.getElementById(c)), t[c].low = t[u].index, t[c].explored = true, c === u)
          break;
      }
  ...
  if (typeof a == "function") {
    ...
    try {
      a.call(
        ...
        function(i) {
          n || (n = true, i === t ? e.reject(new TypeError("circular thenable chain")) : Mv(e, i));
        },
        /*  rejectPromise  */
...
var ta = typeof Promise < "u" ? Promise : Nr, Is = function(e, t, a) {
  ...
  if (s.target = e, s.style = s.style || s.css, s.started = false, s.playing = false, s.hooked = false, s.applying = false, s.progress = 0, s.completes = [], s.frames = [], s.complete && Ue(s.complete) && s.completes.push(s.complete), i) {
    var o = e.position();
...
be(Pt, {
  ...
  hook: function() {
    ...
    if (!e.hooked) {
      ...
      e.queue ? t = a.queue : t = a.current, t.push(this), Dr(e.target) && e.target.cy().addToAnimationPool(e.target), e.hooked = true;
    }
    return this;
  },
  play: function() {
...
var kg = {
  ...
  classes: function(e) {
    ...
    for (var n = [], i = new ra(e), s = 0; s < t.length; s++) {
      for (var o = t[s], l = o._private, u = l.classes, v = false, f = 0; f < e.length; f++) {
        var c = e[f], h = u.has(c);
        if (!h) {
          v = true;
          break;
  ...
  toggleClass: function(e, t) {
    ...
    for (var a = this, n = t === void 0, i = [], s = 0, o = a.length; s < o; s++)
      for (var l = a[s], u = l._private.classes, v = false, f = 0; f < e.length; f++) {
        var c = e[f], h = u.has(c), d = false;
        t || n && !h ? (u.add(c), d = true) : (!t || n && h) && (u.delete(c), d = true), !v && d && (i.push(l), v = true);
      }
...
var qe = function() {
  ...
  populate: function(e, t) {
    if (e.currentSubject != null && e.currentSubject !== t)
      return Ve("Redefinition of subject in selector `" + e.toString() + "`"), false;
    e.currentSubject = t;
...
var Ag = function(e) {
  ...
  for (t.length = 1, a = Rg(a); ; ) {
    var i = Ag(a);
    if (i.expr == null)
      return Ve("The selector `" + e + "`is invalid"), false;
  ...
  for (var u = 0; u < t.length; u++) {
    ...
    if (v.compoundCount > 0 && v.edgeCount > 0)
      return Ve("The selector `" + e + "` is invalid because it uses both a compound selector and an edge selector"), false;
    if (v.edgeCount > 1)
      return Ve("The selector `" + e + "` is invalid because it uses multiple edge selectors"), false;
  ...
  var n, i = ge(e), s = ae(e), o = ge(a), l, u, v = false, f = false, c = false;
  switch (t.indexOf("!") >= 0 && (t = t.replace("!", ""), f = true), t.indexOf("@") >= 0 && (t = t.replace("@", ""), v = true), (i || o || v) && (l = !i && !s ? "" : "" + e, u = "" + a), v && (e = l = l.toLowerCase(), a = u = u.toLowerCase()), t) {
    case "*=":
      n = l.indexOf(u) >= 0;
      break;
    case "$=":
...
var Fg = function(e) {
  ...
  }) : ge(e) ? this.parse(e) || (this.invalid = true) : $e("A selector must be created from a string; found "));
}, ct = ft.prototype;
...
var Rr = function(e, t) {
  ...
  descendants: function(e) {
    ...
    return a(this.children()), this.spawn(t, true).filter(e);
  }
};
function lo(r, e, t, a) {
...
Or = Gv = {
  ...
  silentShift: function(e, t) {
    return Le(e) ? this.shift(e, true) : ge(e) && ae(t) && this.shift(e, t, true), this;
  },
...
pt.boundingBox = function(r) {
  var e, t = r === void 0 || r.useCache === void 0 || r.useCache === true, a = Qt(function(v) {
    var f = v._private;
  ...
  return this.emitting++, _e(e) || (e = [e]), op(this, function(i, s) {
    ...
    for (var o = function() {
      ...
      if (v.type === s.type && (!v.namespace || v.namespace === s.namespace || v.namespace === ip) && i.eventMatches(i.context, v, s)) {
        ...
        i.afterEmit(i.context, v, s), h === false && (s.stopPropagation(), s.preventDefault());
      }
    }, l = 0; l < n; l++)
      o();
...
var up = {
  ...
  eventMatches: function(e, t, a) {
    var n = t.qualifier;
    return n != null ? e !== a.target && Ia(a.target) && n.matches(a.target) : true;
  },
...
var gr = {}, gl = function(e) {
  return function(a) {
    for (var n = this, i = [], s = 0; s < n.length; s++) {
      var o = n[s];
      if (o.isNode()) {
        for (var l = false, u = o.connectedEdges(), v = 0; v < u.length; v++) {
...
He.unique = function() {
  return new fr(this._private.cy, this, true);
};
...
He.clone = function() {
  for (var r = this.cy(), e = [], t = 0; t < this.length; t++) {
    var a = this[t], n = a.json(), i = new In(r, n, false);
    e.push(i);
  }
  return new fr(r, e);
};
...
He.restore = function() {
  ...
  for (f = 0; f < o.length; f++) {
    ...
    if (h.isEdge()) {
      for (var m = h, b = ["source", "target"], w = b.length, E = false, C = 0; C < w; C++) {
        var x = b[C], T = y[x];
        ae(T) && (T = y[x] = "" + y[x]), T == null || T === "" ? ($e("Can not create edge `" + g + "` with unspecified " + x), E = true) : a.hasElementWithId(T) || ($e("Can not create edge `" + g + "` with nonexistant " + x + " `" + T + "`"), E = true);
      }
      if (E) {
        c();
        continue;
    ...
    d.map = new Xr(), d.map.set(g, {
      ele: h,
      index: 0
    }), d.removed = false, e && a.addToPool(h);
  }
  for (var B = 0; B < i.length; B++) {
    ...
    if (L || P._private.parent) {
      ...
      if (I.empty())
        ...
        M || (I[0]._private.children.push(P), P._private.parent = I[0], n.hasCompoundNodes = true);
      }
    }
  }
  if (o.length > 0) {
...
He.remove = function() {
  ...
  function l(R) {
    var L = n[R.id()];
    e && R.removed() || L || (n[R.id()] = true, R.isNode() ? (a.push(R), s(R), o(R)) : a.unshift(R));
  }
  ...
  function y(R, L) {
    ...
    lt(I, L), L._private.parent = null, d.ids[M] || (d.ids[M] = true, d.push(R));
  }
...
He.move = function(r) {
  var e = this._private.cy, t = this, a = false, n = false, i = function(d) {
    return d == null ? d : "" + d;
  };
...
function da(r, e) {
  return r == null || e == null ? false : ae(r) && ae(e) ? true : !!(r && e);
}
function wp(r, e, t, a) {
  var n = e._private;
...
function Cl(r, e) {
  ...
  function n(v, f) {
    var c = v._private, h = c.animation.current, d = c.animation.queue, y = false;
    if (h.length === 0) {
      var g = d.shift();
      g && h.push(g);
    }
    for (var p = function(C) {
      ...
      if (w.stopped) {
        h.splice(m, 1), w.hooked = false, w.playing = false, w.started = false, p(w.frames);
        continue;
      }
      !w.playing && !w.applying || (w.playing && w.applying && (w.applying = false), w.started || wp(v, b, r), bp(v, b, r, f), w.applying && (w.applying = false), p(w.frames), w.step != null && w.step(r), b.completed() && (h.splice(m, 1), w.hooked = false, w.playing = false, w.started = false, p(w.completes)), y = true);
    }
  ...
  for (var s = [], o = {}, l = 0; l < t.length; l++) {
    ...
    if (c || f && h) {
      ...
      for (var y = 0; y < d.length; y++) {
        for (var g = d[y], p = g.name, m = false, b = l + 1; b < t.length; b++) {
          var w = t[b], E = e[b] === wa;
...
ur.applyParsedProperty = function(r, e) {
  ...
  switch (a.mapped) {
    case s.mapData: {
      ...
      if (ae(p)) {
        ...
        return Ve("Do not use continuous mappers without specifying numeric data (i.e. `" + a.field + ": " + p + "` for `" + r.id() + "` is non-numeric)"), false;
    ...
    case s.fn: {
      ...
      if (a.prevFnValue = N, N == null)
        return Ve("Custom function mappers may not return null (i.e. `" + a.name + "` for ele `" + r.id() + "` is null)"), false;
      if (i = this.parse(a.name, N, a.bypass, c), !i)
        return Ve("Custom function mappers may not return invalid values for the property type (i.e. `" + a.name + "` for ele `" + r.id() + "` is invalid)"), false;
      i.mapping = qr(a), a = i;
      break;
    }
    case void 0:
  ...
  return l ? (v ? a.bypassed = u.bypassed : a.bypassed = u, n[a.name] = a) : v ? u.bypassed = a : n[a.name] = a, d(), true;
};
...
ur.updateTransitions = function(r, e) {
  ...
  if (n.length > 0 && i > 0) {
    for (var o = {}, l = false, u = 0; u < n.length; u++) {
      ...
      if (c) {
        var h = c.prev, d = h, y = c.next != null ? c.next : f, g = false, p = void 0, m = 1e-6;
        d && (ae(d.pfValue) && ae(y.pfValue) ? (g = y.pfValue - d.pfValue, p = d.pfValue + m * g) : ae(d.value) && ae(y.value) ? (g = y.value - d.value, p = d.value + m * g) : _e(d.value) && _e(y.value) && (g = d.value[0] !== y.value[0] || d.value[1] !== y.value[1] || d.value[2] !== y.value[2], p = d.strValue), g && (o[v] = y.strValue, this.applyBypass(r, v, p), l = true));
      }
    }
    if (!l)
      return;
    a.transitioning = true, new ta(function(b) {
    ...
    a.transitioning && (this.removeBypasses(r, n), r.emitAndNotify("style"), a.transitioning = false);
};
...
_a.applyBypass = function(r, e, t, a) {
  ...
  if (e === "*" || e === "**") {
    if (t !== void 0)
      for (var o = 0; o < n.properties.length; o++) {
        var l = n.properties[o], u = l.name, v = this.parse(u, t, true);
        v && i.push(v);
      }
  } else if (ge(e)) {
  ...
  if (i.length === 0)
    return false;
  for (var m = false, b = 0; b < r.length; b++) {
...
_a.removeBypasses = function(r, e, t) {
  for (var a = true, n = 0; n < r.length; n++) {
    for (var i = r[n], s = {}, o = 0; o < e.length; o++) {
      ...
      if (!(!v || !v.bypass)) {
        var f = "", c = this.parse(l, f, true), h = s[u.name] = {
          prev: v
        };
...
_r.getNonDefaultPropertiesHash = function(r, e, t) {
  ...
  for (l = 0; l < e.length; l++)
    if (n = e[l], i = r.pstyle(n, false), i != null)
      if (i.pfValue != null)
...
co.appendFromString = function(r) {
  ...
  for (; ; ) {
    ...
    for (var y = []; ; ) {
      ...
      if (!p) {
        Ve("Skipping parsing of block: Invalid formatting of style property and value definitions found in:" + h), d = true;
        break;
      }
      s = p[0];
...
(function() {
  ...
  var l = {
    zeroNonZero: function(q, H) {
      return (q == null || H == null) && q !== H || q == 0 && H != 0 ? true : q != 0 && H == 0;
    },
    any: function(q, H) {
      return q != H;
    },
    ...
    triggersBoundsOfParallelEdges: function(q, H, Y) {
      return q === H ? false : Y.pstyle("curve-style").value === "bezier";
    }
  }, {
    name: "visibility",
    type: u.visibility,
    ...
    triggersBoundsOfParallelEdges: function(q, H) {
      return q === H ? false : q === "bezier" || // remove from bundle
      H === "bezier";
    }
  }, {
...
Un.parse = function(r, e, t, a) {
  ...
  var i = a === "mapping" || a === true || a === false || a == null ? "dontcare" : a, s = t ? "t" : "f", o = "" + e, l = cv(r, o, s, i), u = n.propCache = n.propCache || [], v;
...
Un.parseImpl = function(r, e, t, a) {
  ...
  if (u.multiple && a !== "multiple") {
    ...
    if (l ? b = e.split(/\s+/) : _e(e) ? b = e : b = [e], u.evenMultiple && b.length % 2 !== 0)
      return null;
    for (var w = [], E = [], C = [], x = "", T = false, k = 0; k < b.length; k++) {
...
var kp = {
  ...
  getZoomedViewport: function(e) {
    ...
    if (t.zoomingEnabled || (o = true), ae(e) ? s = e : Le(e) && (s = e.level, e.position != null ? i = On(e.position, n, a) : e.renderedPosition != null && (i = e.renderedPosition), i != null && !t.panningEnabled && (o = true)), s = s > t.maxZoom ? t.maxZoom : s, s = s < t.minZoom ? t.minZoom : s, o || !ae(s) || s === n || i != null && (!ae(i.x) || !ae(i.y)))
      return null;
    if (i != null) {
      var l = a, u = n, v = s, f = {
        x: -v / u * (i.x - l.x) + i.x,
  ...
  viewport: function(e) {
    ...
    if (!e)
      return this;
    if (ae(e.zoom) || (a = false), Le(e.pan) || (n = false), !a && !n)
      return this;
    if (a) {
      var l = e.zoom;
    ...
    if (n && (!s || !e.cancelOnFailedZoom) && t.panningEnabled) {
      var u = e.pan;
      ae(u.x) && (t.pan.x = u.x, o = false), ae(u.y) && (t.pan.y = u.y, o = false), o || i.push("pan");
    }
...
var Ra = function(e) {
  ...
  var c = function(d, y, g) {
    ...
    p.length > 0 && p.remove(), d != null && (Le(d) || _e(d)) && t.add(d), t.one("layoutready", function(b) {
      t.notifications(true), t.emit(b), t.one("load", y), t.emitAndNotify("load");
  ...
  v([o.style, o.elements], function(h) {
    ...
    u.styleEnabled && t.style().append(d), c(y, function() {
      t.startAnimationLoop(), u.ready = true, Ue(o.ready) && t.on("ready", o.ready);
...
be(kn, {
  ...
  mount: function(e) {
    if (e != null) {
      ...
      return !bn(e) && bn(e[0]) && (e = e[0]), t.stopAnimationLoop(), t.destroyRenderer(), a.container = e, a.styleEnabled = true, t.invalidateSize(), t.initRenderer(be({}, n, n.renderer, {
...
af.prototype.run = function() {
  ...
  if (Dr(r.roots))
    ...
    u = e.collection();
    for (var y = function() {
      var ie = d[g], de = ie.maxDegree(false), he = ie.filter(function(Ee) {
        return Ee.degree(false) === de;
      });
      u = u.add(he);
    }, g = 0; g < d.length; g++)
      y();
  ...
  n.bfs({
    ...
    visit: function(ie, de, he, Ee, pe) {
      ...
      Se.isChildless() && b(Se, pe), m[Re] = true;
    }
  });
...
Kn.prototype.run = function() {
  ...
  t.stopped = false, (r.animate === true || r.animate === false) && t.emit({
    type: "layoutstart",
    layout: t
  }), r.debug === true ? bs = true : bs = false;
  var a = Lp(e, t, r);
  bs && Op(a), r.randomize && Np(a);
  var n = Yr(), i = function() {
    zp(a, e, r), r.fit === true && e.fit(r.padding);
  }, s = function(c) {
    ...
    if (b.isNode()) {
      ...
      if (O === "contain") {
        ...
        if (M.edgeType === "bezier" || M.edgeType === "multibezier" || M.edgeType === "self" || M.edgeType === "compound" || M.edgeType === "segments" || M.edgeType === "haystack") {
          for (var V = I.rstyle.bezierPts || I.rstyle.linePts || I.rstyle.haystackPts, G = true, N = 0; N < V.length; N++)
            if (!Ko(c, V[N])) {
              G = false;
              break;
            }
...
var Vs, qs, Vr = {}, Pr = {}, Pl, Al, St, gn, Ur, wt, Ct, zr, Vt, an, hf, gf, _s, Gs, Rl, Ml = function(e, t, a) {
  ...
  St = 1, gn = false, Al < 0 ? Ur < 0 ? Ur = Math.PI + Ur : (Ur = Math.PI - Ur, St = -1, gn = true) : Ur > 0 && (St = -1, gn = true), t.radius !== void 0 ? Vt = t.radius : Vt = n, wt = Ur / 2, an = Math.min(Vr.len / 2, Pr.len / 2), i ? (zr = Math.abs(Math.cos(wt) * Vt / Math.sin(wt)), zr > an ? (zr = an, Ct = Math.abs(zr * Math.sin(wt) / Math.cos(wt))) : Ct = Vt) : (zr = Math.min(an, Vt), Ct = Math.abs(zr * Math.sin(wt) / Math.cos(wt))), _s = t.x + Pr.nx * zr, Gs = t.y + Pr.ny * zr, Vs = _s - Pr.ny * Ct * St, qs = Gs + Pr.nx * Ct * St, hf = t.x + Vr.nx * zr, gf = t.y + Vr.ny * zr, Rl = t;
};
function pf(r, e) {
...
yr.findHaystackPoints = function(r) {
  for (var e = 0; e < r.length; e++) {
    ...
    n.haystackPts = n.allpts = [n.source.x * v * y + l.x, n.source.y * c * y + l.y, n.target.x * f * y + u.x, n.target.y * h * y + u.y], n.midX = (n.allpts[0] + n.allpts[2]) / 2, n.midY = (n.allpts[1] + n.allpts[3]) / 2, n.edgeType = "haystack", n.haystack = true, this.storeEdgeProjections(t), this.calculateArrowAngles(t), this.recalculateEdgeLabelProjections(t), this.calculateLabelAngles(t);
  }
};
...
yr.findTaxiPoints = function(r, e) {
  ...
  }, A = P(D, T), R = P(B, k), L = false;
  m === u ? p = Math.abs(A) > Math.abs(R) ? n : a : m === l || m === o ? (p = a, L = true) : (m === i || m === s) && (p = n, L = true);
  var I = p === a, M = I ? R : A, O = I ? B : D, V = to(O), G = false;
  !(L && (w || C)) && (m === o && O < 0 || m === l && O > 0 || m === i && O > 0 || m === s && O < 0) && (V *= -1, M = V * Math.abs(M), G = true);
  var N;
  if (w) {
    var F = E < 0 ? 1 + E : E;
    N = F * M;
...
yr.checkForInvalidEdgeWarning = function(r) {
  ...
  e.nodesOverlap || ae(e.startX) && ae(e.startY) && ae(e.endX) && ae(e.endY) ? e.loggedErr = false : e.loggedErr || (e.loggedErr = true, Ve("Edge `" + r.id() + "` has invalid endpoints and so it is impossible to draw.  Adjust your edge style (e.g. control points) accordingly or use an alternative edge type.  This is expected behaviour when the source node and the target node overlap."));
};
    ...
    for (var t = this, a = t.cy, n = a.hasCompoundNodes(), i = new Xr(), s = function(k, D) {
      ...
      if (!(v.removed() || !v.takesUpSpace())) {
        ...
        E == null && (E = {
          ...
          pairId: b,
          edgeIsUnbundled: h
        }), i.set(w, E)), E.eles.push(v), h && (E.hasUnbundled = true), d && (E.hasBezier = true);
      }
    }
    for (var C = function() {
...
Ga.findEndpoints = function(r) {
  ...
  m.startX = le[0], m.startY = le[1], m.arrowStartX = ve[0], m.arrowStartY = ve[1], D && (!ae(m.startX) || !ae(m.startY) || !ae(m.endX) || !ae(m.endY) ? m.badLine = true : m.badLine = false);
};
...
`)), s("labelWrapKey", l);
    ...
    var I = r.pstyle("text-max-width").pfValue, M = "", O = "…", V = false;
  ...
  var n = function(s) {
    if (s) {
      ...
      for (var l = 0; l < e.length; l++) {
        ...
        u.isNode() && !v.cleanConnected && (a(u.connectedEdges()), v.cleanConnected = true);
      }
      if (o)
  ...
  if (r.length !== 0) {
    ...
    if (!this.destroyed) {
      ...
      for (var i = 0; i < r.length; i++) {
        ...
        s.isEdge() && (!t(s.source()) || !t(s.target())) && (l.clean = false), s.isEdge() && s.isBundledBezier() && s.parallelEdges().some(function(b) {
...
ia.load = function() {
  ...
  var k = function() {
    ...
    for (var _ = r.findContainerClientCoords(), W = _[0], $ = _[1], Z = _[2], oe = _[3], ee = S.touches ? S.touches : [S], ve = false, le = 0; le < ee.length; le++) {
      var me = ee[le];
    ...
    if (!ve)
      return false;
    for (var De = r.container, Te = S.target, fe = Te.parentNode, Pe = false; fe; ) {
      if (fe === De) {
        Pe = true;
        break;
      }
  ...
  r.registerBinding(r.container, "mousedown", function(S) {
    if (D(S) && !(r.hoverData.which === 1 && S.which !== 1)) {
      S.preventDefault(), b(), r.hoverData.capture = true, r.hoverData.which = S.which;
      var _ = r.cy, W = [S.clientX, S.clientY], $ = r.projectIntoViewport(W[0], W[1]), Z = r.selection, oe = r.findNearestElements($[0], $[1], true, false), ee = oe[0], ve = r.dragData.possibleDragElements;
      ...
      if (S.which == 3) {
        ...
        ee ? (ee.activate(), ee.emit(De), r.hoverData.down = ee) : _.emit(De), r.hoverData.downTime = (/* @__PURE__ */ new Date()).getTime(), r.hoverData.cxtDragged = false;
      } else if (S.which == 1) {
        ee && ee.activate();
        {
        ...
        n(ee, ["mousedown", "tapstart", "vmousedown"], S, {
          ...
          x: $[0],
          y: $[1]
        }, r.redrawHint("select", true), r.redraw()) : ee.pannable() && (Z[4] = 1), me();
      }
      Z[0] = Z[2] = $[0], Z[1] = Z[3] = $[1];
    }
  }, false);
  ...
  r.registerBinding([e, B], "mousemove", function(S) {
    ...
    if (!(!_ && !D(S))) {
      var W = false, $ = r.cy, Z = $.zoom(), oe = [S.clientX, S.clientY], ee = r.projectIntoViewport(oe[0], oe[1]), ve = r.hoverData.mdownPos, le = r.hoverData.mdownGPos, me = r.selection, De = null;
      !r.hoverData.draggingEles && !r.hoverData.dragging && !r.hoverData.selecting && (De = r.findNearestElement(ee[0], ee[1], true, false));
      ...
      var Ze = function(Br) {
        ...
        r.data.bgActivePosistion = void 0, r.hoverData.selecting || $.emit(Ze("boxstart")), me[4] = 1, r.hoverData.selecting = true, r.redrawHint("select", true), r.redraw();
      };
      if (r.hoverData.which === 3) {
        if (je) {
          var $r = Ze("cxtdrag");
          fe ? fe.emit($r) : $.emit($r), r.hoverData.cxtDragged = true, (!r.hoverData.cxtOver || De !== r.hoverData.cxtOver) && (r.hoverData.cxtOver && r.hoverData.cxtOver.emit(Ze("cxtdragout")), r.hoverData.cxtOver = De, De && De.emit(Ze("cxtdragover")));
        }
      } else if (r.hoverData.dragging) {
        if (W = true, $.panningEnabled() && $.userPanningEnabled()) {
          var It;
          ...
          $.panBy(It), $.emit(Ze("dragpan")), r.hoverData.dragged = true;
        }
        ...
        if (je) {
          if (!r.hoverData.dragging && $.boxSelectionEnabled() && (lr || !$.panningEnabled() || !$.userPanningEnabled()))
            ...
            bt && (r.hoverData.dragging = true, r.hoverData.justStartedPan = true, me[4] = 0, r.data.bgActivePosistion = Wt(ve), r.redrawHint("select", true), r.redraw());
          }
        ...
        if (fe && fe.pannable() && fe.active() && fe.unactivate(), (!fe || !fe.grabbed()) && De != Te && (Te && n(Te, ["mouseout", "tapdragout"], S, {
          ...
          if (je) {
            if ($.boxSelectionEnabled() && lr)
              ...
              Er && r.redrawHint("eles", true), r.dragData.didDrag = true, r.hoverData.draggingEles || y(Be, {
                inDragLayer: true
              });
              var hr = {
                x: 0,
              ...
              r.hoverData.draggingEles = true, Be.silentShift(hr).emit(Ze("position")).emit(Ze("drag")), r.redrawHint("drag", true), r.redraw();
            }
          } else
            jr();
        W = true;
  ...
  r.registerBinding(e, "mouseup", function(S) {
    if (!(r.hoverData.which === 1 && S.which !== 1 && r.hoverData.capture)) {
      ...
      if (_) {
        ...
        var W = r.cy, $ = r.projectIntoViewport(S.clientX, S.clientY), Z = r.selection, oe = r.findNearestElement($[0], $[1], true, false), ee = r.dragData.possibleDragElements, ve = r.hoverData.down, le = i(S);
        r.data.bgActivePosistion && (r.redrawHint("select", true), r.redraw()), r.hoverData.tapholdCancelled = true, r.data.bgActivePosistion = void 0, ve && ve.unactivate();
        var me = function(Ke) {
          return {
            originalEvent: S,
            type: Ke,
        ...
        if (r.hoverData.which === 3) {
          ...
          !r.hoverData.isOverThresholdDrag && (n(ve, ["click", "tap", "vclick"], S, {
            x: $[0],
            y: $[1]
          }), A = false, S.timeStamp - R <= W.multiClickDebounceTime() ? (P && clearTimeout(P), A = true, R = null, n(ve, ["dblclick", "dbltap", "vdblclick"], S, {
            x: $[0],
            y: $[1]
          ...
          }, W.multiClickDebounceTime()), R = S.timeStamp)), ve == null && !r.dragData.didDrag && !r.hoverData.selecting && !r.hoverData.dragged && !i(S) && (W.$(t).unselect(["tapunselect"]), ee.length > 0 && r.redrawHint("eles", true), r.dragData.possibleDragElements = ee = W.collection()), oe == ve && !r.dragData.didDrag && !r.hoverData.selecting && oe != null && oe._private.selectable && (r.hoverData.dragging || (W.selectionType() === "additive" || le ? oe.selected() ? oe.unselect(["tapunselect"]) : oe.select(["tapselect"]) : le || (W.$(t).unmerge(oe).unselect(["tapunselect"]), oe.select(["tapselect"]))), r.redrawHint("eles", true)), r.hoverData.selecting) {
            var fe = W.collection(r.getAllInBox(Z[0], Z[1], Z[2], Z[3]));
            r.redrawHint("select", true), fe.length > 0 && r.redrawHint("eles", true), W.emit(me("boxend"));
            var Pe = function(Ke) {
          ...
          if (r.hoverData.dragging && (r.hoverData.dragging = false, r.redrawHint("select", true), r.redrawHint("eles", true), r.redraw()), !Z[4]) {
        ...
        Z[4] = 0, r.hoverData.down = null, r.hoverData.cxtStarted = false, r.hoverData.draggingEles = false, r.hoverData.selecting = false, r.hoverData.isOverThresholdDrag = false, r.dragData.didDrag = false, r.hoverData.dragged = false, r.hoverData.dragDelta = [], r.hoverData.mdownPos = null, r.hoverData.mdownGPos = null, r.hoverData.which = null;
      }
    }
  }, false);
    ...
    if (W == null && (S.wheelDeltaY != null ? W = S.wheelDeltaY / 4 : S.wheelDelta != null && (W = S.wheelDelta / 4)), W !== 0) {
      ...
      if (!r.scrollingPage) {
        ...
        if (ee.panningEnabled() && ee.userPanningEnabled() && ee.zoomingEnabled() && ee.userZoomingEnabled()) {
          S.preventDefault(), r.data.wheelZooming = true, clearTimeout(r.data.wheelTimeout), r.data.wheelTimeout = setTimeout(function() {
  ...
  r.registerBinding(r.container, "wheel", N, true), r.registerBinding(e, "scroll", function(S) {
    r.scrollingPage = true, clearTimeout(r.scrollingPageTimeout), r.scrollingPageTimeout = setTimeout(function() {
      r.scrollingPage = false;
    }, 250);
  }, true), r.registerBinding(r.container, "gesturestart", function(S) {
    r.gestureStartZoom = r.cy.zoom(), r.hasTouchStarted || S.preventDefault();
  }, true), r.registerBinding(r.container, "gesturechange", function(X) {
    r.hasTouchStarted || N(X);
  }, true), r.registerBinding(r.container, "mouseout", function(S) {
  ...
  }, false), r.registerBinding(r.container, "mouseover", function(S) {
    var _ = r.projectIntoViewport(S.clientX, S.clientY);
    r.cy.emit({
      originalEvent: S,
      type: "mouseover",
  ...
  r.registerBinding(r.container, "touchstart", Ce = function(S) {
    if (r.hasTouchStarted = true, !!D(S)) {
      b(), r.touchData.capture = true, r.data.bgActivePosistion = void 0;
      ...
      if (S.touches[1]) {
        r.touchData.singleTouchMoved = true, p(r.dragData.touchDragEles);
        ...
        if (re < De && !S.touches[2]) {
          var Te = r.findNearestElement(W[0], W[1], true, true), fe = r.findNearestElement(W[2], W[3], true, true);
          Te && Te.isNode() ? (Te.activate().emit(oe("cxttapstart")), r.touchData.start = Te) : fe && fe.isNode() ? (fe.activate().emit(oe("cxttapstart")), r.touchData.start = fe) : _.emit(oe("cxttapstart")), r.touchData.start && (r.touchData.start._private.grabbed = false), r.touchData.cxt = true, r.touchData.cxtDragged = false, r.data.bgActivePosistion = void 0, r.redraw();
          return;
        }
      }
      if (S.touches[2])
        ...
        if (S.touches[0]) {
          var Pe = r.findNearestElements(W[0], W[1], true, true), Be = Pe[0];
          if (Be != null && (Be.activate(), r.touchData.start = Be, r.touchData.starts = Pe, r.nodeIsGrabbable(Be))) {
            ...
            r.redrawHint("eles", true), r.redrawHint("drag", true), Be.selected() ? (Ke = _.$(function(er) {
          ...
          n(Be, ["touchstart", "tapstart", "vmousedown"], S, {
            ...
            x: Z[0],
            y: Z[1]
          }, r.redrawHint("select", true), r.redraw()), r.touchData.singleTouchMoved = false, r.touchData.singleTouchStartTime = +/* @__PURE__ */ new Date(), clearTimeout(r.touchData.tapholdTimeout), r.touchData.tapholdTimeout = setTimeout(function() {
            r.touchData.singleTouchMoved === false && !r.pinching && !r.touchData.selecting && n(r.touchData.start, ["taphold"], S, {
              x: W[0],
              y: W[1]
            });
          }, r.tapholdDuration);
  ...
  r.registerBinding(e, "touchmove", we = function(S) {
    ...
    if (!(!_ && !D(S))) {
      ...
      if (_ && r.touchData.cxt) {
        var bt = le("cxtdrag");
        r.data.bgActivePosistion = void 0, r.redrawHint("select", true), r.touchData.start ? r.touchData.start.emit(bt) : $.emit(bt), r.touchData.start && (r.touchData.start._private.grabbed = false), r.touchData.cxtDragged = true;
        ...
        if (te) {
          ...
          if (Br && Br.active()) {
            var hr = r.dragData.touchDragEles;
            p(hr), r.redrawHint("drag", true), r.redrawHint("eles", true), Br.unactivate().emit(le("freeon")), hr.emit(le("free")), r.dragData.didDrag && (Br.emit(le("dragfreeon")), hr.emit(le("dragfree")));
          }
          $.viewport({
            zoom: Zn,
            pan: Qf,
            cancelOnFailedZoom: true
          }), $.emit(le("pinchzoom")), j = wo, F = Ye, U = ir, Q = er, K = lr, r.pinching = true;
        }
        if (S.touches[0]) {
          var ve = r.projectIntoViewport(S.touches[0].clientX, S.touches[0].clientY);
          Z[0] = ve[0], Z[1] = ve[1];
        ...
        if (!r.hoverData.draggingEles && !r.swipePanning && (Er = r.findNearestElement(Z[0], Z[1], true, true)), _ && Mr != null && S.preventDefault(), _ && Mr != null && r.nodeIsDraggable(Mr))
          if (De) {
            ...
            r.hoverData.draggingEles = true, hr.silentShift(la).emit(le("position")).emit(le("drag")), r.redrawHint("drag", true), r.touchData.startPosition[0] == oe[0] && r.touchData.startPosition[1] == oe[1] && r.redrawHint("eles", true), r.redraw();
          } else {
        ...
        if (n(Mr || Er, ["touchmove", "tapdrag", "vmousemove"], S, {
          ...
          for (var Cr = 0; Cr < Z.length; Cr++)
            Z[Cr] && r.touchData.startPosition[Cr] && De && (r.touchData.singleTouchMoved = true);
        if (_ && (Mr == null || Mr.pannable()) && $.panningEnabled() && $.userPanningEnabled()) {
          ...
          Jf && (S.preventDefault(), r.data.bgActivePosistion || (r.data.bgActivePosistion = Wt(r.touchData.startPosition)), r.swipePanning ? ($.panBy({
            x: Te[0] * ee,
            y: Te[1] * ee
          }), $.emit(le("dragpan"))) : De && (r.swipePanning = true, $.panBy({
            x: Pe * ee,
            y: je * ee
          }), $.emit(le("dragpan")), Mr && (Mr.unactivate(), r.redrawHint("select", true), r.touchData.start = null)));
          var ve = r.projectIntoViewport(S.touches[0].clientX, S.touches[0].clientY);
          Z[0] = ve[0], Z[1] = ve[1];
        }
      }
      for (var fe = 0; fe < Z.length; fe++)
        oe[fe] = Z[fe];
      _ && S.touches.length > 0 && !r.hoverData.draggingEles && !r.swipePanning && r.data.bgActivePosistion != null && (r.data.bgActivePosistion = void 0, r.redrawHint("select", true), r.redraw());
    }
  }, false);
  var ye;
  r.registerBinding(e, "touchcancel", ye = function(S) {
    var _ = r.touchData.start;
    r.touchData.capture = false, _ && _.unactivate();
  });
  var ie, de, he, Ee;
  if (r.registerBinding(e, "touchend", ie = function(S) {
    var _ = r.touchData.start, W = r.touchData.capture;
    if (W)
      S.touches.length === 0 && (r.touchData.capture = false), S.preventDefault();
    else
      return;
    var $ = r.selection;
    ...
    if (!S.touches[2] && Z.boxSelectionEnabled() && r.touchData.selecting) {
      ...
      $[0] = void 0, $[1] = void 0, $[2] = void 0, $[3] = void 0, $[4] = 0, r.redrawHint("select", true), Z.emit(me("boxend"));
      var Pe = function($r) {
        return $r.selectable() && !$r.selected();
      };
      fe.emit(me("box")).stdFilter(Pe).select().emit(me("boxselect")), fe.nonempty() && r.redrawHint("eles", true), r.redraw();
    }
      ...
      if (!S.touches[0]) {
        if (!S.touches[0]) {
          ...
          if (_ != null) {
            ...
            p(Be), r.redrawHint("drag", true), r.redrawHint("eles", true), je && (_.emit(me("freeon")), Be.emit(me("free")), r.dragData.didDrag && (_.emit(me("dragfreeon")), Be.emit(me("dragfree")))), n(_, ["touchend", "tapend", "vmouseup", "tapdragout"], S, {
              x: ee[0],
              y: ee[1]
            }), _.unactivate(), r.touchData.start = null;
          } else {
            var Ke = r.findNearestElement(ee[0], ee[1], true, true);
          ...
          r.touchData.singleTouchMoved || (_ || Z.$(":selected").unselect(["tapunselect"]), n(_, ["tap", "vclick"], S, {
            x: ee[0],
            y: ee[1]
          }), de = false, S.timeStamp - Ee <= Z.multiClickDebounceTime() ? (he && clearTimeout(he), de = true, Ee = null, n(_, ["dbltap", "vdblclick"], S, {
            x: ee[0],
            y: ee[1]
          ...
          }, Z.multiClickDebounceTime()), Ee = S.timeStamp)), _ != null && !r.dragData.didDrag && _._private.selectable && jr < r.touchTapThreshold2 && !r.pinching && (Z.selectionType() === "single" ? (Z.$(t).unmerge(_).unselect(["tapunselect"]), _.select(["tapselect"])) : _.selected() ? _.unselect(["tapunselect"]) : _.select(["tapselect"]), r.redrawHint("eles", true)), r.touchData.singleTouchMoved = true;
        }
      }
    }
    for (var Ze = 0; Ze < ee.length; Ze++)
      ve[Ze] = ee[Ze];
    r.dragData.didDrag = false, S.touches.length === 0 && (r.touchData.dragDelta = [], r.touchData.startPosition = [null, null, null, null, null, null], r.touchData.startGPosition = null, r.touchData.didSelect = false), S.touches.length < 2 && (S.touches.length === 1 && (r.touchData.startGPosition = [S.touches[0].clientX, S.touches[0].clientY]), r.pinching = false, r.redrawHint("eles", true), r.redraw());
...
Qr.generateBottomRoundrectangle = function() {
  return this.nodeShapes["bottom-round-rectangle"] = this.nodeShapes.bottomroundrectangle = {
    ...
    intersectLine: function(e, t, a, n, i, s, o, l) {
      var u = e - (a / 2 + o), v = t - (n / 2 + o), f = v, c = e + (a / 2 + o), h = it(i, s, e, t, u, v, c, f, false);
...
nr.getElement = function(r, e, t, a, n) {
  ...
  if (g.context.setTransform(1, 0, 0, 1, 0, 0), g.context.clearRect(g.usedWidth, 0, f, d), m(k))
    ...
    g.context.translate(g.usedWidth, 0), g.context.scale(u, u), this.drawElement(g.context, r, e, c, false), g.context.scale(1 / u, 1 / u), g.context.translate(-g.usedWidth, 0);
  }
  return h = {
    x: g.usedWidth,
    texture: g,
  ...
  if (n) {
    ...
    if (o)
      for (var l = 0; l < a.length; l++) {
        ...
        v.invalidatedWidth += u.width, u.invalidated = true, e.checkTextureUtility(v);
      }
    e.removeFromQueue(r);
  }
};
...
nr.recycleTexture = function(r, e) {
  for (var t = this, a = t.getTextureQueue(r), n = t.getRetiredTextureQueue(r), i = 0; i < n.length; i++) {
    var s = n[i];
    if (s.width >= e)
      return s.retired = false, s.usedWidth = 0, s.invalidatedWidth = 0, s.fullnessChecks = 0, eo(s.eleCaches), s.context.setTransform(1, 0, 0, 1, 0, 0), s.context.clearRect(0, 0, s.width, s.height), lt(n, s), a.push(s), s;
  }
};
...
var by = 1, xa = -4, Pn = 2, wy = 3.99, xy = 50, Ey = 50, Cy = 0.15, Ty = 0.1, Sy = 0.9, ky = 0.9, Dy = 1, zl = 250, By = 4e3 * 4e3, Fl = 32767, Py = true, kf = function(e) {
  var t = this, a = t.renderer = e, n = a.cy;
  t.layersByLevel = {}, t.firstGet = true, t.lastInvalidationTime = Yr() - 2 * zl, t.skipping = false, t.eleTxrDeqs = n.collection(), t.scheduleElementRefinement = Fa(function() {
    t.refineElementTextures(t.eleTxrDeqs), t.eleTxrDeqs.unmerge(t.eleTxrDeqs);
  }, Ey), a.beforeRender(function(s, o) {
    o - t.lastInvalidationTime <= zl ? t.skipping = true : t.skipping = false;
...
dr.getLayers = function(r, e, t) {
  ...
  var y = function() {
    ...
    if (B != null) {
      ...
      (D.insert === void 0 || D.insert) && v.unshift(L);
    return L;
  };
  if (a.skipping && !o)
    return null;
...
dr.drawEleInLayer = function(r, e, t, a) {
  ...
  o.w === 0 || o.h === 0 || !e.visible() || (t = n.getEleLevelForLayerLevel(t, a), i.setImgSmoothing(s, false), i.drawCachedElement(s, e, null, null, t, Py), i.setImgSmoothing(s, true));
};
...
dr.haveLayers = function() {
  for (var r = this, e = false, t = xa; t <= Pn; t++) {
...
dr.invalidateLayer = function(r) {
  if (this.lastInvalidationTime = Yr(), !r.invalid) {
    ...
    lt(a, r), r.elesQueue = [], r.invalid = true, r.replacement && (r.replacement.invalid = true);
  ...
  if (!(u.w === 0 || u.h === 0)) {
    ...
    if (v != null) {
      ...
      if (c !== 0) {
        ...
        b = C.x, w = C.y, r.translate(b, w), r.rotate(c), E = l.getImgSmoothing(r), E || l.setImgSmoothing(r, true);
        var x = t.getRotationOffset(e);
        p = x.x, m = x.y;
      } else
        p = h, m = d;
      var T;
      f !== 1 && (T = r.globalAlpha, r.globalAlpha = T * f), r.drawImage(v.texture.canvas, v.x, 0, v.width, v.height, p, m, y, g), f !== 1 && (r.globalAlpha = T), c !== 0 && (r.rotate(-c), r.translate(-b, -w), E || l.setImgSmoothing(r, false));
    } else
      t.drawElement(r, e);
  }
};
...
Hr.drawCachedElement = function(r, e, t, a, n, i) {
  var s = this, o = s.data, l = o.eleTxrCache, u = o.lblTxrCache, v = o.slbTxrCache, f = o.tlbTxrCache, c = e.boundingBox(), h = i === true ? l.reasons.highQuality : null;
...
Jr.drawEdgePath = function(r, e, t, a) {
  var n = r._private.rscratch, i = e, s, o = false, l = this.usePaths(), u = r.pstyle("line-dash-pattern").pfValue, v = r.pstyle("line-dash-offset").pfValue;
  if (l) {
    var f = t.join("$"), c = n.pathCacheKey && n.pathCacheKey === f;
    c ? (s = e = n.pathCache, o = true) : (s = e = new Path2D(), n.pathCacheKey = f, n.pathCache = s);
  }
  if (i.setLineDash)
    switch (a) {
      case "dotted":
...
Jr.drawArrowShape = function(r, e, t, a, n, i, s, o, l) {
  var u = this, v = this.usePaths() && n !== "triangle-cross", f = false, c, h = e, d = {
    x: s,
    y: o
  ...
  if (v) {
    ...
    w != null ? (c = e = w, f = true) : (c = e = new Path2D(), m[b] = c);
  }
...
mo.drawInscribedImage = function(r, e, t, a, n) {
  ...
  if (v(t, "background-width", "value", a) !== "auto" && (v(t, "background-width", "units", a) === "%" ? D = v(t, "background-width", "pfValue", a) * g : D = v(t, "background-width", "pfValue", a)), v(t, "background-height", "value", a) !== "auto" && (v(t, "background-height", "units", a) === "%" ? B = v(t, "background-height", "pfValue", a) * p : B = v(t, "background-height", "pfValue", a)), !(D === 0 || B === 0)) {
    ...
    var U = r.globalAlpha;
    r.globalAlpha = E;
    var Q = i.getImgSmoothing(r), K = false;
    if (C === "no" && Q ? (i.setImgSmoothing(r, false), K = true) : C === "yes" && !Q && (i.setImgSmoothing(r, true), K = true), c === "no-repeat")
...
Lt.setupTextStyle = function(r, e) {
  var t = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : true, a = e.pstyle("font-style").strValue, n = e.pstyle("font-size").pfValue + "px", i = e.pstyle("font-family").strValue, s = e.pstyle("font-weight").strValue, o = t ? e.effectiveOpacity() * e.pstyle("text-opacity").value : 1, l = e.pstyle("text-outline-opacity").value * o, u = e.pstyle("color").value, v = e.pstyle("text-outline-color").value;
...
yt.drawNode = function(r, e, t) {
  var a = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true, n = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : true, i = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : true, s = this, o, l, u = e._private, v = u.rscratch, f = e.position();
  if (!(!ae(f.x) || !ae(f.y)) && !(i && !e.visible())) {
    var c = i ? e.effectiveOpacity() : 1, h = s.usePaths(), d, y = false, g = e.padding();
    ...
    var ne = function() {
      ...
      var W = s.nodePathCache = s.nodePathCache || [], $ = cv(S === "polygon" ? S + "," + _.join(",") : S, "" + X, "" + ue, "" + re), Z = W[$], oe, ee = false;
      return Z != null ? (oe = Z, ee = true, v.pathCache = oe) : (oe = new Path2D(), W[$] = v.pathCache = oe), {
        path: oe,
        cacheHit: ee
      };
    ...
    var ce = function() {
      ...
      for (var ue = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : c, X = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : true, S = u.backgrounding, _ = 0, W = 0; W < E.length; W++) {
      ...
      u.backgrounding = _ !== C, S !== u.backgrounding && e.updateStyle(false);
    }, Ce = function() {
      var ue = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : false, X = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : c;
    ...
    if (Se) {
      ...
      r.translate(Re, Oe), z(), de(), ne(Ne * A), ce(), Ae(ze, true), J(Ne * N), ie(), Ce(B !== 0 || P !== 0), we(B !== 0 || P !== 0), Ae(ze, false), ye(ze), r.translate(-Re, -Oe);
    }
    h && r.translate(-f.x, -f.y), Ee(), h && r.translate(f.x, f.y), z(), de(), ne(), ce(), Ae(c, true), J(), ie(), Ce(B !== 0 || P !== 0), we(B !== 0 || P !== 0), Ae(c, false), ye(), h && r.translate(-f.x, -f.y), pe(), he(), t && r.translate(p.x1, p.y1);
  }
};
var Pf = function(e) {
  if (!["overlay", "underlay"].includes(e))
...
yt.drawPie = function(r, e, t, a) {
  ...
  if (y && (l = 0, u = 0), i.units === "%" ? c = c * i.pfValue : i.pfValue !== void 0 && (c = i.pfValue / 2), s.units === "%" ? h = c * s.pfValue : s.pfValue !== void 0 && (h = s.pfValue / 2), !(h >= c))
    for (var g = 1; g <= n.pieBackgroundN; g++) {
      ...
      p === 0 || d >= 1 || d + w > 1 || (h === 0 ? (r.beginPath(), r.moveTo(l, u), r.arc(l, u, c, E, x), r.closePath()) : (r.beginPath(), r.arc(l, u, c, E, x), r.arc(l, u, h, x, E, true), r.closePath()), this.colorFillStyle(r, m[0], m[1], m[2], b), r.fill(), d += w);
    }
};
...
xr.paintCache = function(r) {
  for (var e = this.paintCaches = this.paintCaches || [], t = true, a, n = 0; n < e.length; n++)
...
xr.render = function(r) {
  ...
  var p = c;
  a || (e.prevPxRatio !== l && (e.invalidateContainerClientCoordsCache(), e.matchCanvasSize(e.container), e.redrawHint("eles", true), e.redrawHint("drag", true)), e.prevPxRatio = l), !a && e.motionBlurTimeout && clearTimeout(e.motionBlurTimeout), c && (e.mbFrames == null && (e.mbFrames = 0), e.mbFrames++, e.mbFrames < 3 && (p = false), e.mbFrames > e.minMbLowQualFrames && (e.motionBlurPxRatio = e.mbPxRBlurry)), e.clearingMotionBlur && (e.motionBlurPxRatio = 1), e.textureDrawLastFrame && !f && (v[e.NODE] = true, v[e.SELECT_BOX] = true);
  ...
  if (f || (e.textureDrawLastFrame = false), f) {
    ...
    var b = t.zoom();
    P(R, false), R.clearRect(x.mpan.x, x.mpan.y, x.width / x.zoom / l, x.height / x.zoom / l), R.drawImage(L, x.mpan.x, x.mpan.y, x.width / x.zoom / l, x.height / x.zoom / l);
  } else
  ...
  if (N[e.NODE] = !v[e.NODE] && c && !e.clearedForMotionBlur[e.NODE] || e.clearingMotionBlur, N[e.NODE] && (e.clearedForMotionBlur[e.NODE] = true), N[e.DRAG] = !v[e.DRAG] && c && !e.clearedForMotionBlur[e.DRAG] || e.clearingMotionBlur, N[e.DRAG] && (e.clearedForMotionBlur[e.DRAG] = true), v[e.NODE] || n || i || N[e.NODE]) {
    var F = c && !N[e.NODE] && h !== 1, R = a || (F ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_NODE] : u.contexts[e.NODE]), U = c && !F ? "motionBlur" : void 0;
    P(R, U), G ? e.drawCachedNodes(R, D.nondrag, l, O) : e.drawLayeredElements(R, D.nondrag, l, O), e.debug && e.drawDebugPoints(R, D.nondrag), !n && !c && (v[e.NODE] = false);
  }
  if (!i && (v[e.DRAG] || n || N[e.DRAG])) {
    var F = c && !N[e.DRAG] && h !== 1, R = a || (F ? e.data.bufferContexts[e.MOTIONBLUR_BUFFER_DRAG] : u.contexts[e.DRAG]);
    P(R, c && !F ? "motionBlur" : void 0), G ? e.drawCachedNodes(R, D.drag, l, O) : e.drawCachedElements(R, D.drag, l, O), e.debug && e.drawDebugPoints(R, D.drag), !n && !c && (v[e.DRAG] = false);
  }
  if (this.drawSelectionRectangle(r, P), c && h !== 1) {
    ...
    (v[e.NODE] || N[e.NODE]) && (ne(Q, K, N[e.NODE]), v[e.NODE] = false), (v[e.DRAG] || N[e.DRAG]) && (ne(j, re, N[e.DRAG]), v[e.DRAG] = false);
  }
  e.prevViewport = x, e.clearingMotionBlur && (e.clearingMotionBlur = false, e.motionBlurCleared = true, e.motionBlur = true), c && (e.motionBlurTimeout = setTimeout(function() {
    e.motionBlurTimeout = null, e.clearedForMotionBlur[e.NODE] = false, e.clearedForMotionBlur[e.DRAG] = false, e.motionBlur = false, e.clearingMotionBlur = !f, e.mbFrames = 0, v[e.NODE] = true, v[e.DRAG] = true, e.redraw();
  }, _y)), a || t.emit("render");
};
var ha;
...
function Fr(r, e, t, a) {
  ...
  r.bindBuffer(r.ARRAY_BUFFER, f), r.bufferData(r.ARRAY_BUFFER, e * v, r.DYNAMIC_DRAW), r.enableVertexAttribArray(a), o === r.FLOAT ? r.vertexAttribPointer(a, s, o, false, v, 0) : o === r.INT && r.vertexAttribIPointer(a, s, o, v, 0), r.vertexAttribDivisor(a, 1), r.bindBuffer(r.ARRAY_BUFFER, null);
...
function Jy(r, e, t) {
  ...
  for (var u = 0; u < 3; u++) {
    var v = t + u;
    r.enableVertexAttribArray(v), r.vertexAttribPointer(v, 3, r.FLOAT, false, 3 * 12, u * 12), r.vertexAttribDivisor(v, 1);
  }
...
var tm = /* @__PURE__ */ function() {
  function r(e, t, a, n) {
    ht(this, r), this.debugID = Math.floor(Math.random() * 1e4), this.r = e, this.texSize = t, this.texRows = a, this.texHeight = Math.floor(t / a), this.enableWrapping = true, this.locked = false, this.texture = null, this.needsBuffer = true, this.freePointer = {
      x: 0,
      row: 0
  ...
  return gt(r, [{
    ...
    value: function(t, a, n) {
      ...
      return this.keyToLocation.set(t, d), this.needsBuffer = true, d;
    }
  }, {
    key: "getOffsets",
    value: function(t) {
    ...
    key: "bufferIfNeeded",
    value: function(t) {
      this.texture || (this.texture = Yy(t, this.debugID)), this.needsBuffer && (this.texture.buffer(this.canvas), this.needsBuffer = false, this.locked && (this.canvas = null, this.scratch = null));
    }
  }, {
    key: "dispose",
    value: function() {
...
var im = /* @__PURE__ */ function() {
  ...
  return gt(r, [{
              ...
              var m = function() {
                ...
                if (v(E)) {
                  ...
                  if (s)
                    ...
                    B !== void 0 && !Ky(T, B) && (f = true, a.typeAndIdToKey.delete(D), B.forEach(function(P) {
                      return C.markKeyForGC(P);
                    }));
                  }
                }
    ...
    value: function(t, a, n, i) {
      var s = this.renderTypes.get(a), o = this.collections.get(s.collection), l = false, u = o.draw(i, n, function(c) {
        s.drawClipped ? (c.save(), c.beginPath(), c.rect(0, 0, n.w, n.h), c.clip(), s.drawElement(c, t, n, true, true), c.restore()) : s.drawElement(c, t, n, true, true), l = true;
      });
      if (l) {
    ...
    */
      ...
      if (this._isVisible(t, o) && !(t.isEdge() && !this._isValidEdge(t))) {
        ...
        try {
          for (v.s(); !(f = v.n()).done; ) {
            ...
            for (var g = s.getAtlasIndexForBatch(h), p = 0, m = [[d, true], [y, false]]; p < m.length; p++) {
    ...
    value: function(t, a, n, i) {
      ...
      if (n.shapeProps && n.shapeProps.padding && (o = t.pstyle(n.shapeProps.padding).pfValue), i) {
        ...
        var h = n.getBoundingBox(t), d = this._getAdjustedBB(h, o, true, 1);
    ...
    value: function() {
      ...
      if (i !== 0) {
        ...
        t.uniform1f(s.uZoom, Wy(this.r)), t.uniformMatrix3fv(s.uPanZoomMatrix, false, this.panZoomMatrix), t.uniform1i(s.uAtlasSize, this.batchManager.getAtlasSize());
...
function wm(r, e, t, a, n) {
  ...
  p.bindFramebuffer(p.FRAMEBUFFER, r.pickingFrameBuffer), r.pickingFrameBuffer.needsDraw && (p.viewport(0, 0, p.canvas.width, p.canvas.height), Of(r, null, Ea.PICKING), r.pickingFrameBuffer.needsDraw = false);
  ...
  if (t.screen && r.data.canvasNeedsRedraw[r.SELECT_BOX] && ym(r, e), r.data.canvasNeedsRedraw[r.NODE] || t.picking) {
    ...
    if (i = l.length, n.startFrame(o, t), t.screen) {
      ...
      for (var f = 0; f < l.length; f++)
        Ds(r, f, l[f]);
    n.endFrame(), t.screen && r.webglDebugShowAtlases && (mm(r), bm(r)), r.data.canvasNeedsRedraw[r.NODE] = false, r.data.canvasNeedsRedraw[r.DRAG] = false;
  }
  if (r.webglDebug) {
    var c = performance.now(), h = false, d = Math.ceil(c - a), y = n.getDebugInfo(), g = ["".concat(i, " elements"), "".concat(y.totalInstances, " instances"), "".concat(y.batchCount, " batches"), "".concat(y.totalAtlases, " atlases"), "".concat(y.wrappedCount, " wrapped textures"), "".concat(y.simpleCount, " simple shapes")].join(", ");
    if (h)
...
function Vf(r) {
  ...
  for (var u = 0; u < ke.CANVAS_LAYERS; u++) {
    ...
    e.data.contexts[u] = v.getContext(f), e.data.contexts[u] || $e("Could not create canvas of type " + f), Object.keys(l).forEach(function(J) {
      v.style[J] = l[J];
    }), v.style.position = "absolute", v.setAttribute("data-id", "layer" + u), v.style.zIndex = String(ke.CANVAS_LAYERS - u), e.data.canvasContainer.appendChild(v), e.data.canvasNeedsRedraw[u] = false;
  }
  ...
  var c = wr(), h = function(z) {
    ...
    return e.drawElement(z, q, H, false, false, te);
