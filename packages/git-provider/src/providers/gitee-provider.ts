...
export class GiteeProvider implements GitProvider {
  ...
  async getCommits(options: {
    ...
    const response = await fetch(
      `https://gitee.com/api/v5/repos/${options.owner}/${options.repo}/commits?${params}`,
      {
        headers: {
          Authorization: `token ${this.options.token}`,
          "Content-Type": "application/json",
  ...
  async getCommit(options: {
    ...
    const response = await fetch(
      `https://gitee.com/api/v5/repos/${options.owner}/${options.repo}/commits/${options.sha}`,
      {
        headers: {
          Authorization: `token ${this.options.token}`,
          "Content-Type": "application/json",
  ...
  async getDiff(options: {
    ...
    const response = await fetch(
      `https://gitee.com/api/v5/repos/${options.owner}/${options.repo}/compare/${options.base}...${options.head}`,
      {
        headers: {
          Authorization: `token ${this.options.token}`,
          "Content-Type": "application/json",
  ...
  async mergeBranch(options: {
    ...
    const response = await fetch(
      `https://gitee.com/api/v5/repos/${options.owner}/${options.repo}/merges`,
      {
        method: "POST",
        headers: {
          Authorization: `token ${this.options.token}`,
  ...
  async createPullRequest(options: {
    ...
    const response = await fetch(
      `https://gitee.com/api/v5/repos/${options.owner}/${options.repo}/pulls`,
      {
        method: "POST",
        headers: {
          Authorization: `token ${this.options.token}`,
  ...
  async getPullRequests(options: {
    ...
    const response = await fetch(
      `https://gitee.com/api/v5/repos/${options.owner}/${options.repo}/pulls?${params}`,
      {
        headers: {
          Authorization: `token ${this.options.token}`,
          "Content-Type": "application/json",
  ...
  async mergePullRequest(options: {
    ...
    const response = await fetch(
      `https://gitee.com/api/v5/repos/${options.owner}/${options.repo}/pulls/${options.pull_number}/merge`,
      {
        method: "PUT",
        headers: {
          Authorization: `token ${this.options.token}`,
